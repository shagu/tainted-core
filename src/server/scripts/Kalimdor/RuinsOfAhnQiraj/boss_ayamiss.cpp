...
public:
  ...
  struct boss_ayamissAI : public ScriptedAI {
    ...
    void EnterCombat(Unit *who) { pTarget = who; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_ayamissAI(pCreature); }
};

void AddSC_boss_ayamiss() { new boss_ayamiss(); }
