...
public:
  ...
  struct boss_chrono_lord_dejaAI : public ScriptedAI {
    ...
    void EnterCombat(Unit *) { DoScriptText(SAY_AGGRO, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_chrono_lord_dejaAI(pCreature); }
};

void AddSC_boss_chrono_lord_deja() { new boss_chrono_lord_deja(); }
