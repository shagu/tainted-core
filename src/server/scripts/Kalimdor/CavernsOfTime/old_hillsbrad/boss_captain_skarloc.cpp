...
public:
      ...
      if (type == POINT_MOTION_TYPE) {
        ...
        case 0:
          ...
          if (Creature *Thrall = me->GetMap()->GetCreature(ThrallinGUID))
            Thrall->SummonCreature(SKARLOC_MOUNT, 2049.90f, 256.85f, 62.822f, me->GetOrientation(),
                                   TEMPSUMMON_DEAD_DESPAWN, 5000);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_captain_skarlocAI(pCreature); }
};

void AddSC_boss_captain_skarloc() { new boss_captain_skarloc(); }
