...
#define SAY_ONAGGRO                                                                                                    \
  "Abandon all hope! The legion has returned to finish what was begun so many years ago. This time there will be no "  \
  "escape!"
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_azgalorAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_lesser_doomguardAI(pCreature); }
};
