...
#define SAY_ONAGGRO                                                                                                    \
  "The Legion's final conquest has begun! Once again the subjugation of this world is within our grasp. Let none "     \
  "survive!"
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_rage_winterchillAI(pCreature); }
};

void AddSC_boss_rage_winterchill() { new boss_rage_winterchill(); }
