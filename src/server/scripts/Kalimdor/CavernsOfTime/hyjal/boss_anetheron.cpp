...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_anetheronAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_towering_infernalAI(pCreature); }
};
