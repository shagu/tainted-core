...
public:
  ...
  struct boss_sarturaAI : public ScriptedAI {
    ...
    void KilledUnit(Unit * /*victim*/) { DoScriptText(SAY_SLAY, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_sarturaAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_sartura_royal_guardAI(pCreature); }
};
