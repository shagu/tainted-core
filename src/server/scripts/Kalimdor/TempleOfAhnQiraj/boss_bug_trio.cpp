...
#define SPELL_ENRAGE 34624       // Changed cause 25790 is casted on gamers too. Same prob with old explosion of twin
                           // emperors.
...
public:
  ...
  struct boss_kriAI : public ScriptedAI {
    boss_kriAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_kriAI(pCreature); }
};
...
public:
  ...
  struct boss_vemAI : public ScriptedAI {
    boss_vemAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_vemAI(pCreature); }
};
...
public:
  ...
  struct boss_yaujAI : public ScriptedAI {
    boss_yaujAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
    ...
    void JustDied(Unit * /*Killer*/) {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        Creature *Summoned = me->SummonCreature(15621, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 0,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_yaujAI(pCreature); }
};
