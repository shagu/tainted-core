...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new aqsentinelAI(creature); }
  ...
  struct aqsentinelAI : public ScriptedAI {
    ...
    void ClearBuddyList() { NearbyGUID[0] = NearbyGUID[1] = NearbyGUID[2] = 0; }
...
void AddSC_npc_anubisath_sentinel() { new npc_anubisath_sentinel(); }
