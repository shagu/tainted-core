...
public:
  ...
  struct instance_temple_of_ahnqirajAI : public ScriptedInstance {
    instance_temple_of_ahnqirajAI(Map *map) : ScriptedInstance(map) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_temple_of_ahnqirajAI(pMap); }
};
