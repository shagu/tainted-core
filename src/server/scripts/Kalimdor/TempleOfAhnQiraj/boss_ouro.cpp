...
public:
  ...
  struct boss_ouroAI : public ScriptedAI {
    ...
    void EnterCombat(Unit * /*who*/) { DoCastVictim(SPELL_BIRTH); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_ouroAI(pCreature); }
};

void AddSC_boss_ouro() { new boss_ouro(); }
