...
public:
  ...
  struct boss_amnennar_the_coldbringerAI : public ScriptedAI {
    ...
    void KilledUnit() { DoScriptText(SAY_KILL, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_amnennar_the_coldbringerAI(pCreature); }
};

void AddSC_boss_amnennar_the_coldbringer() { new boss_amnennar_the_coldbringer(); }
