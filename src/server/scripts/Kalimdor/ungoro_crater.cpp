...
public:
  ...
  struct npc_ameAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 i) {
      ...
      case 19:
        me->SummonCreature(ENTRY_STOMPER, -6391.69f, -1730.49f, -272.83f, 4.96f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
      ...
      case 28:
        ...
        break;
      case 38:
        me->SummonCreature(ENTRY_TARLORD, -6370.75f, -1382.84f, -270.51f, 6.06f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        DoScriptText(SAY_AGGRO2, me, pPlayer);
        break;
      case 49:
        me->SummonCreature(ENTRY_TARLORD1, -6324.44f, -1181.05f, -270.17f, 4.34f,
    ...
    void Reset() { DEMORALIZINGSHOUT_Timer = 5000; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_ameAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_ringoAI(pCreature); }
