...
#define GOSSIP_BEAR4                                                                                                   \
  "I have heard your words, Great Bear Spirit, and I understand. I now seek your blessings to fully learn the way of " \
  "the Claw."
...
float Clintar_spirit_WP[41][5] = {
    ...
    {7465.28f, -3115.46f, 439.327f, 0.83f, 4000},  {7476.49f, -3101, 443.457f, 0.89f, 0},
    {7486.57f, -3085.59f, 439.478f, 1.07f, 0},     {7472.19f, -3085.06f, 443.142f, 3.07f, 0},
    {7456.92f, -3085.91f, 438.862f, 3.24f, 0},     {7446.68f, -3083.43f, 438.245f, 2.40f, 0},
    {7446.17f, -3080.21f, 439.826f, 1.10f, 6000},  {7452.41f, -3085.8f, 438.984f, 5.78f, 0},
    {7469.11f, -3084.94f, 443.048f, 6.25f, 0},     {7483.79f, -3085.44f, 439.607f, 6.25f, 0},
    {7491.14f, -3090.96f, 439.983f, 5.44f, 0},     {7497.62f, -3098.22f, 436.854f, 5.44f, 0},
    {7498.72f, -3113.41f, 434.596f, 4.84f, 0},     {7500.06f, -3122.51f, 434.749f, 5.17f, 0},
    {7504.96f, -3131.53f, 434.475f, 4.74f, 0},     {7504.31f, -3133.53f, 435.693f, 3.84f, 6000},
    {7504.55f, -3133.27f, 435.476f, 0.68f, 15000}, {7501.99f, -3126.01f, 434.93f, 1.83f, 0},
    {7490.76f, -3114.97f, 434.431f, 2.51f, 0},     {7479.64f, -3105.51f, 431.123f, 1.83f, 0},
    {7474.63f, -3086.59f, 428.994f, 1.83f, 2000},  {7472.96f, -3074.18f, 427.566f, 1.57f, 0},
    {7472.25f, -3063, 428.268f, 1.55f, 0},         {7473.46f, -3054.22f, 427.588f, 0.36f, 0},
    {7475.08f, -3053.6f, 428.653f, 0.36f, 6000},   {7474.66f, -3053.56f, 428.433f, 3.19f, 4000},
    {7471.81f, -3058.84f, 427.073f, 4.29f, 0},     {7472.16f, -3064.91f, 427.772f, 4.95f, 0},
    {7471.56f, -3085.36f, 428.924f, 4.72f, 0},     {7473.56f, -3093.48f, 429.294f, 5.04f, 0},
    {7478.94f, -3104.29f, 430.638f, 5.23f, 0},     {7484.46f, -3109.61f, 432.769f, 5.79f, 0},
    {7490.23f, -3111.08f, 434.431f, 0.02f, 0},     {7496.29f, -3108, 434.783f, 1.15f, 0},
    {7497.46f, -3100.66f, 436.191f, 1.50f, 0},     {7495.64f, -3093.39f, 438.349f, 2.10f, 0},
    {7492.44f, -3086.01f, 440.267f, 1.38f, 0},     {7498.26f, -3076.44f, 440.808f, 0.71f, 0},
    {7506.4f, -3067.35f, 443.64f, 0.77f, 0},       {7518.37f, -3057.42f, 445.584f, 0.74f, 0},
...
float PhantasmsSpawnpos[6][4] = {
    {7865.17f, -2549.79f, 486.685f, 5.0f}, {7889.45f, -2580.95f, 487.039f, 1.7f}, {7916.65f, -2556.21f, 487.336f, 1.1f},
    {7926.25f, -2574.34f, 489.651f, 2.9f}, {7855.32f, -2595.67f, 486.713f, 0.5f}, {7890.27f, -2529.94f, 483.771f, 4.7f},
};
...
Location PristessHomePoint[] = {{7883.12f, -2560.05f, 486.837f, 0.02f}, {7882.61f, -2562.55f, 486.947f, 6.17f},
                                {7882.21f, -2565.84f, 486.947f, 6.13f}, {7882.12f, -2569.81f, 486.947f, 6.18f},
                                {7878.62f, -2563.07f, 486.947f, 0.03f}, {7878.14f, -2566.98f, 486.947f, 6.13f},
...
public:
    ...
    void StartEvent(Player *pPlayer) {
      ...
      if (pPlayer->GetQuestStatus(10965) == QUEST_STATUS_INCOMPLETE) {
        for (uint8 i = 0; i < 41; ++i)
          AddWaypoint(i, Clintar_spirit_WP[i][0], Clintar_spirit_WP[i][1], Clintar_spirit_WP[i][2],
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (Event_onWait && Event_Timer <= diff) {
        ...
        case 20:
          switch (Step) {
          case 0: {
            Creature *mob = me->SummonCreature(ASPECT_RAVEN, ASPECT_RAVEN_SUMMON_X, ASPECT_RAVEN_SUMMON_Y,
                                               ASPECT_RAVEN_SUMMON_Z, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 2000);
            if (mob) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_clintar_spiritAI(pCreature); }
};
...
public:
  ...
  bool OnGossipHello(Player *pPlayer, Creature *pCreature) override {
    ...
    if (pPlayer->GetQuestStatus(5929) == QUEST_STATUS_INCOMPLETE ||
        pPlayer->GetQuestStatus(5930) == QUEST_STATUS_INCOMPLETE) {
...
public:
  ...
  bool OnQuestAccept(Player *pPlayer, Creature *pCreature, Quest const *quest) override {
    if (quest->GetQuestId() == 10965) {
      Creature *clintar_spirit = pCreature->SummonCreature(
          CLINTAR_SPIRIT, CLINTAR_SPIRIT_SUMMON_X, CLINTAR_SPIRIT_SUMMON_Y, CLINTAR_SPIRIT_SUMMON_Z,
          CLINTAR_SPIRIT_SUMMON_O, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 100000);
      if (clintar_spirit)
...
public:
      ...
      if (uiPhase) {
        if (EventTimer <= diff) {
          ...
          case 3:
            ...
            break;
          case 4:
            if (Creature *pEranikus = me->SummonCreature(NPC_ERANIKUS, 7867.44f, -2671.37f, 498.042f, 0.51f,
          ...
          case 11:
            ...
            for (int i = 0; i < NPC_NIGHTMARE_PHANTASMS_COUNT; i++) {
              ...
              me->SummonCreature(NPC_NIGHTMARE_PHANTASM, PhantasmsSpawnpos[r][0] + collision,
                                 PhantasmsSpawnpos[r][1] + collision, PhantasmsSpawnpos[r][2] + 2,
                                 PhantasmsSpawnpos[r][3], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000);
            }
            SetCanAttack(true);
            PhantasmPhase = true;
          ...
          case 12:
            ...
            for (int i = 0; i < NPC_MOONGLADE_WARDENS_COUNT; i++) {
              ...
              if (Creature *pWarden = me->SummonCreature(
                      NPC_MOONGLADE_WARDEN, PhantasmsSpawnpos[r][0] + collision, PhantasmsSpawnpos[r][1] + collision,
          ...
          case 15:
            if (Creature *pEranikus = Unit::GetCreature(*me, EranikusGUID)) {
              for (int i = 0; i < NPC_MOONGLADE_WARDENS_COUNT; i++)
                me->SummonCreature(NPC_MOONGLADE_WARDEN, pEranikus->GetPositionX(), pEranikus->GetPositionY(),
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_remulosAI(pCreature); }
...
public:
      ...
      if (EventTimer <= diff) {
        ...
        case 0:
          if (HealthBelowPct(80)) {
            ...
            if (Creature *pTyrande = me->SummonCreature(NPC_TYRANDE, 7927.01f, -2573.36f, 489.652f, 2.81f,
                                                        TEMPSUMMON_CORPSE_TIMED_DESPAWN, 60000)) {
        ...
        case 6:
          if (HealthBelowPct(20)) {
            ...
            for (std::set<Unit *>::const_iterator itr = me->getAttackers().begin(); itr != me->getAttackers().end();
                 ++itr) {
            ...
            for (int i = 0; i < NPC_PRIESTESS_OF_THE_MOON_COUNT; i++) {
              ...
              if (Creature *pPristess =
                      me->SummonCreature(NPC_PRIESTESS_OF_THE_MOON, 7927.01f + collision, -2573.36f + collision,
                                         489.652f + collision, 2.81f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 20000)) {
        ...
        case 13:
          ...
          if (!PriestessOfTheMoonList.empty()) {
            for (std::list<uint64>::iterator itr = PriestessOfTheMoonList.begin(); itr != PriestessOfTheMoonList.end();
                 ++itr) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_eranikusAI(pCreature); }
};
