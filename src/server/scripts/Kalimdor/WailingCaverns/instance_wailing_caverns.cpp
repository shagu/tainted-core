...
public:
  ...
  struct instance_wailing_cavernsAI : public ScriptedInstance {
    instance_wailing_cavernsAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_wailing_cavernsAI(pMap); }
};
