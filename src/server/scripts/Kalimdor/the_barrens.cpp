...
enum eQuests { QUEST_LOST_IN_BATTLE = 4921 };
...
Position const AffrayChallengerLoc[6] = {{-1683.0f, -4326.0f, 2.79f, 0.0f},  {-1682.0f, -4329.0f, 2.79f, 0.0f},
                                         {-1683.0f, -4330.0f, 2.79f, 0.0f},  {-1680.0f, -4334.0f, 2.79f, 1.49f},
                                         {-1674.0f, -4326.0f, 2.79f, 3.49f}, {-1677.0f, -4334.0f, 2.79f, 1.66f}};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_giltharesAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_taskmaster_fizzuleAI(pCreature); }
};
...
public:
      ...
      if (EventInProgress) {
        ...
        if (!EventGrate) {
          ...
          if (x >= -1684 && x <= -1674 && y >= -4334 && y <= -4324) {
            ...
            for (uint8 i = 0; i < 6; ++i) {
              Creature *creature = me->SummonCreature(NPC_AFFRAY_CHALLENGER, AffrayChallengerLoc[i],
          ...
          if (WaveTimer <= diff) {
            if (Wave < 6 && !EventBigWill) {
              ...
              if (Creature *creature = me->SummonCreature(NPC_BIG_WILL, -1722, -4341, 6.12f, 6.26f,
                                                          TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 480000)) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_twiggy_flatheadAI(pCreature); }
};
...
public:
  ...
  struct npc_wizzlecrank_shredderAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 uiPointId) {
      ...
      case 9:
        ...
        break;
      case 17:
        if (Creature *pTemp = me->SummonCreature(NPC_MERCENARY, 1128.489f, -3037.611f, 92.701f, 1.472f,
                                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000)) {
          DoScriptText(SAY_MERCENARY, pTemp);
          me->SummonCreature(NPC_MERCENARY, 1160.172f, -2980.168f, 97.313f, 3.690f,
                             TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        }
        break;
      case 24:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_wizzlecrank_shredderAI(pCreature); }
};
