...
public:
  ...
  struct npc_muglashAI : public npc_escortAI {
    ...
    void DoWaveSummon() {
      switch (m_uiWaveId) {
      case 1:
        me->SummonCreature(NPC_WRATH_RIDER, m_afFirstNagaCoord[0][0], m_afFirstNagaCoord[0][1],
                           m_afFirstNagaCoord[0][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        me->SummonCreature(NPC_WRATH_SORCERESS, m_afFirstNagaCoord[1][0], m_afFirstNagaCoord[1][1],
                           m_afFirstNagaCoord[1][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        me->SummonCreature(NPC_WRATH_RAZORTAIL, m_afFirstNagaCoord[2][0], m_afFirstNagaCoord[2][1],
                           m_afFirstNagaCoord[2][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        break;
      case 2:
        me->SummonCreature(NPC_WRATH_PRIESTESS, m_afSecondNagaCoord[0][0], m_afSecondNagaCoord[0][1],
                           m_afSecondNagaCoord[0][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        me->SummonCreature(NPC_WRATH_MYRMIDON, m_afSecondNagaCoord[1][0], m_afSecondNagaCoord[1][1],
                           m_afSecondNagaCoord[1][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        me->SummonCreature(NPC_WRATH_SEAWITCH, m_afSecondNagaCoord[2][0], m_afSecondNagaCoord[2][1],
                           m_afSecondNagaCoord[2][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 60000);
        break;
      case 3:
        me->SummonCreature(NPC_VORSHA, m_fVorshaCoord[0], m_fVorshaCoord[1], m_fVorshaCoord[2], 0.0f,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_muglashAI(pCreature); }
};
...
public:
  ...
  struct npc_torekAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 i) {
      ...
      case 19:
        ...
        me->SummonCreature(ENTRY_DURIEL, 1776.73f, -2049.06f, 109.83f, 1.54f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(ENTRY_SILVERWING_SENTINEL, 1774.64f, -2049.41f, 109.83f, 1.40f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
        me->SummonCreature(ENTRY_SILVERWING_WARRIOR, 1778.73f, -2049.50f, 109.83f, 1.67f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
        break;
      case 20:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_torekAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_ruul_snowhoofAI(pCreature); }
};
...
#define SAY_END_1                                                                                                      \
  "Well done! I should be fine on my own from here. Remember to talk to Delgren when you return to Maestra's Post in " \
  "Ashenvale."
  ...
  struct npc_feeroAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 waypointId) {
      ...
      case 18:
        ...
        me->SummonCreature(NPC_DARK_STRAND_ASSASSINS, 3491.09f, 214.76f, 11.36f, 3.30f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
        me->SummonCreature(NPC_DARK_STRAND_ASSASSINS, 3491.18f, 212.28f, 11.25f, 3.03f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
        me->SummonCreature(NPC_DARK_STRAND_ASSASSINS, 3490.74f, 210.59f, 11.32f, 3.03f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
        me->SummonCreature(NPC_DARK_STRAND_ASSASSINS, 3490.46f, 208.78f, 11.39f, 2.93f,
                           TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
        break;
      case 19:
      ...
      case 27:
        ...
        me->SummonCreature(NPC_FORSAKEN_SCOUT, 3782.51f, 145.57f, 8.54f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
        me->SummonCreature(NPC_FORSAKEN_SCOUT, 3778.84f, 143.46f, 8.41f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
        me->SummonCreature(NPC_FORSAKEN_SCOUT, 3782.26f, 149.61f, 8.34f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
      ...
      case 41:
        ...
        me->SummonCreature(NPC_CAEDAKAR_LEFT, 4108.34f, 53.69f, 26.18f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
        me->SummonCreature(NPC_ALIGAR_MIDDLE, 4114.55f, 54.48f, 27.21f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
        me->SummonCreature(NPC_BALIZAR_RIGHT, 4116.81f, 50.14f, 26.15f, 2.93f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           30000);
