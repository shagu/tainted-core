...
float m_afBanditLoc[6][6] = {{-4905.479492f, -2062.732666f, 84.352f}, {-4915.201172f, -2073.528320f, 84.733f},
                             {-4878.883301f, -1986.947876f, 91.966f}, {-4877.503906f, -1966.113403f, 91.859f},
                             {-4767.985352f, -1873.169189f, 90.192f}, {-4788.861328f, -1888.007813f, 89.888f}};
...
float m_afWyvernLoc[3][3] = {
    {-4990.606f, -906.057f, -5.343f}, {-4970.241f, -927.378f, -4.951f}, {-4985.364f, -952.528f, -5.199f}};
...
enum ePlucky { FACTION_FRIENDLY = 35, QUEST_SCOOP = 1950, SPELL_PLUCKY_HUMAN = 9192, SPELL_PLUCKY_CHICKEN = 9220 };

/*#####
#npc_panter
######*/

enum ePantherCage { ENRAGED_PANTHER = 10992 };
...
public:
  ...
  struct npc_kanatiAI : public npc_escortAI {
    ...
    void DoSpawnGalak() {
      for (int i = 0; i < 3; ++i)
        me->SummonCreature(NPC_GALAK_ASS, m_afGalakLoc[0], m_afGalakLoc[1], m_afGalakLoc[2], 0.0f,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_kanatiAI(pCreature); }
...
public:
  ...
  struct npc_lakota_windsongAI : public npc_escortAI {
    ...
    void DoSpawnBandits(int uiAmbushId) {
      for (int i = 0; i < 2; ++i)
        me->SummonCreature(NPC_GRIM_BANDIT, m_afBanditLoc[i + uiAmbushId][0], m_afBanditLoc[i + uiAmbushId][1],
                           m_afBanditLoc[i + uiAmbushId][2], 0.0f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 60000);
    }
  };
...
public:
  ...
  struct npc_paoka_swiftmountainAI : public npc_escortAI {
    ...
    void DoSpawnWyvern() {
      for (int i = 0; i < 3; ++i)
        me->SummonCreature(NPC_WYVERN, m_afWyvernLoc[i][0], m_afWyvernLoc[i][1], m_afWyvernLoc[i][2], 0.0f,
                           TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 60000);
    }
  };

  CreatureAI *GetAI(Creature *pCreature) const { return new npc_paoka_swiftmountainAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_pluckyAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_enraged_pantherAI(pCreature); }
};
