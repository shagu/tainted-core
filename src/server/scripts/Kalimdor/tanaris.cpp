...
public:
  ...
  struct mob_aquementasAI : public ScriptedAI {
    ...
    void SendItem(Unit *receiver) {
      if (CAST_PLR(receiver)->HasItemCount(11169, 1, false) && CAST_PLR(receiver)->HasItemCount(11172, 11, false) &&
          CAST_PLR(receiver)->HasItemCount(11173, 1, false) && !CAST_PLR(receiver)->HasItemCount(11522, 1, true)) {
    ...
    void EnterCombat(Unit *who) { DoScriptText(AGGRO_YELL_AQUE, me, who); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_aquementasAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_custodian_of_timeAI(pCreature); }
};
...
public:
  ...
  bool OnGossipSelect(Player *pPlayer, Creature *pCreature, uint32 /*uiSender*/, uint32 uiAction) override {
    ...
    case GOSSIP_ACTION_INFO_DEF + 1:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_NORGANNON_3, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 2);
      pPlayer->SEND_GOSSIP_MENU(1676, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 2:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_NORGANNON_4, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 3);
      pPlayer->SEND_GOSSIP_MENU(1677, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 3:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_NORGANNON_5, GOSSIP_SENDER_MAIN,
...
public:
  ...
  struct npc_OOX17AI : public npc_escortAI {
    ...
    void WaypointReached(uint32 i) {
      ...
      switch (i) {
      case 23:
        me->SummonCreature(SPAWN_FIRST, -8350.96f, -4445.79f, 10.10f, 6.20f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_FIRST, -8355.96f, -4447.79f, 10.10f, 6.27f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_FIRST, -8353.96f, -4442.79f, 10.10f, 6.08f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        DoScriptText(SAY_OOX_AMBUSH, me);
        break;

      case 56:
        me->SummonCreature(SPAWN_SECOND_1, -7510.07f, -4795.50f, 9.35f, 6.06f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_SECOND_2, -7515.07f, -4797.50f, 9.35f, 6.22f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_SECOND_2, -7518.07f, -4792.50f, 9.35f, 6.22f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        DoScriptText(SAY_OOX_AMBUSH, me);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_OOX17AI(pCreature); }
...
public:
  ...
  bool OnGossipHello(Player *player, GameObject * /*_GO*/) override {
    ...
    spawn = player->SummonCreature(NPC_SWASHBUCKLER, -10029.86f, -4030.51f, 20.02f, 3.40f, TEMPSUMMON_TIMED_DESPAWN,
                                   340000);
    if (spawn)
      spawn->GetMotionMaster()->MovePath(PATH_ENTRY_4, true);
    spawn = player->SummonCreature(NPC_SWASHBUCKLER, -10031.83f, -4030.70f, 19.52f, 3.40f, TEMPSUMMON_TIMED_DESPAWN,
                                   340000);
    if (spawn)
      spawn->GetMotionMaster()->MovePath(PATH_ENTRY_5, true);

    spawn =
        player->SummonCreature(NPC_BUCCANEER, -10028.90f, -4029.65f, 20.53f, 3.40f, TEMPSUMMON_TIMED_DESPAWN, 340000);
    if (spawn)
...
public:
        ...
        if (HasFollowState(STATE_FOLLOW_POSTEVENT)) {
          if (m_uiPostEventTimer <= uiDiff) {
            ...
            case 6:
              ...
              me->GetMotionMaster()->MovePoint(POINT_ID_TO_WATER, m_afToWaterLoc[0], m_afToWaterLoc[1],
                                               m_afToWaterLoc[2]);
              break;
            }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_toogaAI(pCreature); }
