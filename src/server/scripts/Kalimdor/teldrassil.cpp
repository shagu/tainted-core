...
public:
        ...
        if (HasFollowState(STATE_FOLLOW_POSTEVENT)) {
          if (m_uiPostEventTimer <= uiDiff) {
            ...
            case 1:
              ...
              me->GetMotionMaster()->MovePoint(POINT_ID_TO_FOREST, m_afToForestLoc[0], m_afToForestLoc[1],
                                               m_afToForestLoc[2]);
              break;
            }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_mistAI(pCreature); }
...
void AddSC_teldrassil() { new npc_mist(); }
