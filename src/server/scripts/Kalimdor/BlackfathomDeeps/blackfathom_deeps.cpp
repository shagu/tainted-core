...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_blackfathom_deeps_eventAI(pCreature); }
};

enum eMorridune { SAY_MORRIDUNE_1 = -1048003, SAY_MORRIDUNE_2 = -1048004 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_morriduneAI(pCreature); }
};
