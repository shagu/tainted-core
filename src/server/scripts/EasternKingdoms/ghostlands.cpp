...
public:
  ...
  bool OnGossipHello(Player *player, GameObject * /*_GO*/) override {
    if (player->GetQuestStatus(9678) == QUEST_STATUS_INCOMPLETE) {
      Creature *Stillblade =
          player->SummonCreature(17716, 8106.11f, -7542.06f, 151.775f, 3.02598f, TEMPSUMMON_DEAD_DESPAWN, 60000);
      if (Stillblade)
...
public:
  ...
  struct npc_ranger_lilathaAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 i) {
      ...
      case 18: {
        ...
        Creature *Summ1 =
            me->SummonCreature(16342, 7627.083984f, -7532.538086f, 152.128616f, 1.082733f, TEMPSUMMON_DEAD_DESPAWN, 0);
        Creature *Summ2 =
            me->SummonCreature(16343, 7620.432129f, -7532.550293f, 152.454865f, 0.827478f, TEMPSUMMON_DEAD_DESPAWN, 0);
        if (Summ1 && Summ2) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_ranger_lilathaAI(pCreature); }
