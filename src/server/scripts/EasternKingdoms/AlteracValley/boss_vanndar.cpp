...
public:
  ...
  struct boss_vanndarAI : public ScriptedAI {
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (uiYellTimer <= diff) {
        DoScriptText(
            RAND(YELL_RANDOM1, YELL_RANDOM2, YELL_RANDOM3, YELL_RANDOM4, YELL_RANDOM5, YELL_RANDOM6, YELL_RANDOM7), me);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_vanndarAI(pCreature); }
};
