...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_sulfuronAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_flamewaker_priestAI(pCreature); }
};
