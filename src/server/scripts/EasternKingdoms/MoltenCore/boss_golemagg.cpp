...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_golemaggAI(pCreature); }
};
...
public:
  ...
  struct mob_core_ragerAI : public ScriptedAI {
    mob_core_ragerAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_core_ragerAI(pCreature); }
};
