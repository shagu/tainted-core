...
public:
  ...
  struct instance_molten_coreAI : public ScriptedInstance {
    instance_molten_coreAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_molten_coreAI(pMap); }
};
