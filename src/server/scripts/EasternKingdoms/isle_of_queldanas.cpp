...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_converted_sentryAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_greengill_slaveAI(pCreature); }
};
