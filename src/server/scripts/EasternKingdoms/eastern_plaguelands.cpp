...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mobs_ghoul_flayerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_darrowshire_spiritAI(pCreature); }
