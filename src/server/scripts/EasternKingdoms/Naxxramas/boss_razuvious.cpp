...
public:
  ...
  struct boss_razuviousAI : public ScriptedAI {
    ...
    void JustDied(Unit *) { DoPlaySoundToSet(me, SOUND_DEATH); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_razuviousAI(pCreature); }
};

void AddSC_boss_razuvious() { new boss_razuvious(); }
