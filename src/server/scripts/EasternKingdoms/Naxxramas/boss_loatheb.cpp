...
public:
  ...
  struct boss_loathebAI : public ScriptedAI {
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (InevitableDoom5mins_Timer <= diff) {
        ...
        InevitableDoom5mins_Timer -= diff;
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_loathebAI(pCreature); }
};
