...
public:
      ...
      if (me->GetVictim() && me->IsAlive()) {
        ...
        if (Phase3 && (GuardiansOfIcecrown_Count < 5)) {
          if (GuardiansOfIcecrown_Timer <= diff) {
            ...
            switch (rand() % 6) {
            case 0:
              pUnit = me->SummonCreature(16441, ADDX_LEFT_FAR, ADDY_LEFT_FAR, ADDZ_LEFT_FAR, ADDO_LEFT_FAR,
              ...
              break;
            case 1:
              pUnit = me->SummonCreature(16441, ADDX_LEFT_MIDDLE, ADDY_LEFT_MIDDLE, ADDZ_LEFT_MIDDLE, ADDO_LEFT_MIDDLE,
                                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
              ...
              break;
            case 2:
              pUnit = me->SummonCreature(16441, ADDX_LEFT_NEAR, ADDY_LEFT_NEAR, ADDZ_LEFT_NEAR, ADDO_LEFT_NEAR,
                                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
              // Start moving guardian towards the center of the room
            ...
            case 3:
              ...
              pUnit = me->SummonCreature(16441, ADDX_RIGHT_FAR, ADDY_RIGHT_FAR, ADDZ_RIGHT_FAR, ADDO_RIGHT_FAR,
                                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
              // Start moving guardian towards the center of the room
              ...
              break;
            case 4:
              pUnit = me->SummonCreature(16441, ADDX_RIGHT_MIDDLE, ADDY_RIGHT_MIDDLE, ADDZ_RIGHT_MIDDLE,
                                         ADDO_RIGHT_MIDDLE, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
              // Start moving guardian towards the center of the room
              ...
              break;
            case 5:
              pUnit = me->SummonCreature(16441, ADDX_RIGHT_NEAR, ADDY_RIGHT_NEAR, ADDZ_RIGHT_NEAR, ADDO_RIGHT_NEAR,
                                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
              // Start moving guardian towards the center of the room
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_kelthuzadAI(pCreature); }
};

void AddSC_boss_kelthuzad() { new boss_kelthuzad(); }
