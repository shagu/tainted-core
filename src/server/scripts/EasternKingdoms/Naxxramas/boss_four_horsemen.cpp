...
public:
  ...
  struct boss_lady_blaumeuxAI : public ScriptedAI {
    ...
    void EnterCombat(Unit * /*who*/) { DoScriptText(SAY_BLAU_AGGRO, me); }

    void KilledUnit(Unit * /*Victim*/) { DoScriptText(SAY_BLAU_SLAY, me); }

    void JustDied(Unit * /*Killer*/) { DoScriptText(SAY_BLAU_DEATH, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_lady_blaumeuxAI(pCreature); }
};
...
public:
  ...
  struct boss_rivendare_naxxAI : public ScriptedAI {
    ...
    void JustDied(Unit * /*Killer*/) { DoScriptText(SAY_RIVE_DEATH, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_rivendare_naxxAI(pCreature); }
};
...
public:
  ...
  struct boss_thane_korthazzAI : public ScriptedAI {
    ...
    void EnterCombat(Unit * /*who*/) { DoScriptText(SAY_KORT_AGGRO, me); }

    void KilledUnit(Unit * /*Victim*/) { DoScriptText(SAY_KORT_SLAY, me); }

    void JustDied(Unit * /*Killer*/) { DoScriptText(SAY_KORT_DEATH, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_thane_korthazzAI(pCreature); }
};
...
public:
  ...
  struct boss_sir_zeliekAI : public ScriptedAI {
    ...
    void EnterCombat(Unit * /*who*/) { DoScriptText(SAY_ZELI_AGGRO, me); }

    void KilledUnit(Unit * /*Victim*/) { DoScriptText(SAY_ZELI_SLAY, me); }

    void JustDied(Unit * /*Killer*/) { DoScriptText(SAY_ZELI_DEATH, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_sir_zeliekAI(pCreature); }
};
