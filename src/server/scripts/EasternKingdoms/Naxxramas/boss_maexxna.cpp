...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_webwrapAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_maexxnaAI(pCreature); }
};
