...
Point P1[] = {{-8407.58f, 463.477f, 123.761f}, {-8408.53f, 464.716f, 123.761f}};
Point P2[] = {{-8434.93f, 441.242f, 121.922f}, {-8436.16f, 442.804f, 121.923f}};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_stormwind_royal_guardAI(pCreature); }
};
...
public:
  ...
  struct npc_lord_gregor_lescovarAI : public npc_escortAI {
    npc_lord_gregor_lescovarAI(Creature *pCreature) : npc_escortAI(pCreature) { pCreature->RestoreFaction(); }
    ...
    void WaypointReached(uint32 uiPointId) {
      ...
      case 5:
        SetEscortPaused(true);
        if (Creature *pMarzon = me->SummonCreature(NPC_MARZON_BLADE, -8411.360352f, 480.069733f, 123.760895f, 4.941504f,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_lord_gregor_lescovarAI(pCreature); }
};
...
public:
  ...
  struct npc_bartlebyAI : public ScriptedAI {
    ...
    void JustDied(Unit *) { me->SetFaction(11); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_bartlebyAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_dashel_stonefistAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_general_marcus_jonathanAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_tyrion_spybotAI(pCreature); }
};
...
public:
  ...
  struct npc_marzon_silent_bladeAI : public ScriptedAI {
    npc_marzon_silent_bladeAI(Creature *pCreature) : ScriptedAI(pCreature) { me->SetWalk(true); }

    void Reset() { me->RestoreFaction(); }

    void EnterCombat(Unit *) { DoScriptText(SAY_MARZON_2, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_marzon_silent_bladeAI(pCreature); }
};
