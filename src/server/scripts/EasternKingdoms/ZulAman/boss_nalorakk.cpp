...
float NalorakkWay[8][3] = {
    ...
    {-69.908f, 1419.721f, 27.31f}, {-79.929f, 1395.958f, 27.31f}, {-80.072f, 1374.555f, 40.87f}, // waypoint 3
...
enum // Sounds
{
  ...
  SOUND_NALORAKK_EVENT1 = 12078, // "What could be better than servin' da bear spirit for eternity? Come closer now.
                                 // Bring your souls to me!"
...
static const char YELL_BERSERK[] =
    "You had your chance, now it be too late!"; // Never seen this being used, so just guessing from what I hear.
...
public:
      ...
      if (waitTimer) {
        if (inMove) {
          if (waitTimer <= diff) {
            ...
            (*me).GetMotionMaster()->MovePoint(MovePhase, NalorakkWay[MovePhase][0], NalorakkWay[MovePhase][1],
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_nalorakkAI(pCreature); }
};
