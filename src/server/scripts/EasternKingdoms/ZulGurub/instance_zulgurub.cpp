...
public:
  ...
  struct instance_zulgurubAI : public ScriptedInstance {
    instance_zulgurubAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_zulgurubAI(pMap); }
};
void AddSC_instance_zulgurub() { new instance_zulgurub(); }
