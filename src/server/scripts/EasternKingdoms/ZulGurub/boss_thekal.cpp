...
enum Texts { SAY_TRANSFORM = -1309009, SAY_DEATH = -1309010 };
...
public:
  ...
  struct boss_thekalAI : public ScriptedAI {
    boss_thekalAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_thekalAI(pCreature); }
};
...
public:
  ...
  struct mob_zealot_lorkhanAI : public ScriptedAI {
    mob_zealot_lorkhanAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_zealot_lorkhanAI(pCreature); }
};
...
public:
  ...
  struct mob_zealot_zathAI : public ScriptedAI {
    mob_zealot_zathAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_zealot_zathAI(pCreature); }
};
