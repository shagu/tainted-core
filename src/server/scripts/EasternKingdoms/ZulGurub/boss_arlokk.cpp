...
public:
  ...
  struct boss_arlokkAI : public ScriptedAI {
    ...
    void DoSummonPhanters() {
      ...
      me->SummonCreature(NPC_ZULIAN_PROWLER, -11532.7998f, -1649.6734f, 41.4800f, 0.0f,
                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 15000);
      me->SummonCreature(NPC_ZULIAN_PROWLER, -11532.9970f, -1606.4840f, 41.2979f, 0.0f,
                         TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 15000);
    }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_arlokkAI(pCreature); }
};
...
public:
  ...
  struct mob_prowlerAI : public ScriptedAI {
    ...
    void JustDied(Unit * /*pKiller*/) { --m_uiSummonCount; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_prowlerAI(pCreature); }
};
