...
#define GOSSIP_SELECT2                                                                                                 \
  "Start making sense, dwarf. I don't want to have anything to do with your cracker, your pappy, or any sort of "      \
  "'discreditin'."
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_ragged_johnAI(pCreature); }
};

void AddSC_burning_steppes() { new npc_ragged_john(); }
