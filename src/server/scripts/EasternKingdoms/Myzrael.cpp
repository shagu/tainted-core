...
public:
  ...
  struct npc_myzraelAI : public ScriptedAI {
    npc_myzraelAI(Creature *creature) : ScriptedAI(creature) { Initialize(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_myzraelAI(pCreature); }
};
...
public:
  ...
  struct npc_prismatic_exileAI : public ScriptedAI {
    npc_prismatic_exileAI(Creature *creature) : ScriptedAI(creature) { Initialize(); }
    ...
    void EnterCombat(Unit *victim) override { me->SetReactState(REACT_AGGRESSIVE); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_prismatic_exileAI(pCreature); }
};
