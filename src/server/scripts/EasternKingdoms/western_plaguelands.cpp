...
SD%Complete: 90
SDComment: Quest support: 5216, 5219, 5222, 5225, 5229, 5231, 5233, 5235, 9446. To obtain Vitreous Focuser (could use
more spesifics about gossip items) SDCategory: Western Plaguelands EndScriptData */
...
enum eAndorhalTower { GO_BEACON_TORCH = 176093 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_the_scourge_cauldronAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_andorhal_towerAI(pCreature); }
};
...
public:
  ...
  struct npc_anchorite_truuenAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 uiPointId) {
      ...
      case 8:
        ...
        for (int i = 0; i < 2; i++)
          me->SummonCreature(NPC_GHOUL, 1035.43f, -1572.97f, 61.5412f, 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                             90000);
        break;
      case 9:
      ...
      case 14:
        for (int i = 0; i < 4; i++)
          me->SummonCreature(NPC_GHOUL, 1159.77f, -1762.64f, 60.5699f, 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                             30000);
        break;
      case 15:
      ...
      case 22:
        ...
        break;
      case 23:
        if (Creature *pUter = me->SummonCreature(NPC_GHOST_UTHER, 971.86f, -1825.42f, 81.99f, 0.0f,
                                                 TEMPSUMMON_MANUAL_DESPAWN, 10000)) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_anchorite_truuenAI(pCreature); }
