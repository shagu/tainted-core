...
public:
  ...
  struct boss_JammalAI : public ScriptedAI {
    boss_JammalAI(Creature *creature) : ScriptedAI(creature) { Initialize(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_JammalAI(pCreature); }
};

void AddSC_boss_Jammal() { new boss_Jammal(); }
