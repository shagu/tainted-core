...
float IntroWay[8][3] = {{-11053.37f, -1794.48f, 149}, {-11141.07f, -1841.40f, 125}, {-11187.28f, -1890.23f, 125},
                        {-11189.20f, -1931.25f, 125}, {-11153.76f, -1948.93f, 125}, {-11128.73f, -1929.75f, 125},
                        {-11140, -1915, 122},         {-11163, -1903, 91.473f}};
...
public:
        ...
        if (WaitTimer <= diff) {
          if (Intro) {
            ...
            if (MovePhase >= 7) {
              ...
              me->GetMotionMaster()->MovePoint(MovePhase, IntroWay[MovePhase][0], IntroWay[MovePhase][1],
                                               IntroWay[MovePhase][2]);
              ++MovePhase;
            }
          }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_nightbaneAI(pCreature); }
};

void AddSC_boss_nightbane() { new boss_nightbane(); }
