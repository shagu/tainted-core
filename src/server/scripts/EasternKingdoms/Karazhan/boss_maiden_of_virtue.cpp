...
enum eEvents { EVENT_REPENTANCE = 1, EVENT_HOLYFIRE = 2, EVENT_HOLYWRATH = 3, EVENT_HOLYGROUND = 4, EVENT_ENRAGE = 5 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_maiden_of_virtueAI(pCreature); }
};

void AddSC_boss_maiden_of_virtue() { new boss_maiden_of_virtue(); }
