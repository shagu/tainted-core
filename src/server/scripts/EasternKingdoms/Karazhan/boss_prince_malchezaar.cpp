...
static InfernalPoint InfernalPoints[] = {
    {-10922.8f, -1985.2f}, {-10916.2f, -1996.2f}, {-10932.2f, -2008.1f}, {-10948.8f, -2022.1f}, {-10958.7f, -1997.7f},
    {-10971.5f, -1997.5f}, {-10990.8f, -1995.1f}, {-10989.8f, -1976.5f}, {-10971.6f, -1973.0f}, {-10955.5f, -1974.0f},
    {-10939.6f, -1969.8f}, {-10958.0f, -1952.2f}, {-10941.7f, -1954.8f}, {-10943.1f, -1988.5f}, {-10948.8f, -2005.1f},
    {-10984.0f, -2019.3f}, {-10932.8f, -1979.6f}, {-10932.8f, -1979.6f}, {-10935.7f, -1996.0f}};
...
public:
  ...
  struct netherspite_infernalAI : public ScriptedAI {
    netherspite_infernalAI(Creature *c)
        : ScriptedAI(c), malchezaar(0), HellfireTimer(0), CleanupTimer(0), point(NULL) {}
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new netherspite_infernalAI(pCreature); }
};
...
public:
  ...
  struct boss_malchezaarAI : public ScriptedAI {
    boss_malchezaarAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
    ...
    void EnterCombat(Unit * /*who*/) {
      ...
      if (pInstance)
        pInstance->HandleGameObject(pInstance->GetData64(DATA_GO_NETHER_DOOR),
                                    false); // Open the door leading further in
    }
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (phase == 1) {
        ...
        if ((me->GetHealth() * 100) / me->GetMaxHealth() < 30) {
          ...
          for (uint8 i = 0; i < 2; ++i) {
            Creature *axe = me->SummonCreature(MALCHEZARS_AXE, me->GetPositionX(), me->GetPositionY(),
                                               me->GetPositionZ(), 0, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 1000);
            if (axe) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_malchezaarAI>(pCreature); }
};
