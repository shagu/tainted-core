...
enum MiscSpells { SPELL_CIRCULAR_BLIZZARD = 29952, SPELL_WATERBOLT = 31012, SPELL_SHADOW_PYRO = 29978 };

// Creatures
enum Creatures { NPC_WATER_ELEMENTAL = 17167, NPC_SHADOW_OF_ARAN = 18254, NPC_ARAN_BLIZZARD = 17161 };
...
public:
  ...
  struct boss_shade_of_aranAI : public ScriptedAI {
    boss_shade_of_aranAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
    ...
    void KilledUnit(Unit * /*victim*/) { DoScriptText(RAND(SAY_KILL1, SAY_KILL2), me); }
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (!Drinking && me->GetMaxPower(POWER_MANA) &&
          (me->GetPower(POWER_MANA) * 100 / me->GetMaxPower(POWER_MANA)) < 20) {
        Drinking = true;
      ...
      if (SuperCastTimer <= diff) {
        ...
        case SUPER_BLIZZARD:
          ...
          Blizzard = me->SummonCreature(NPC_ARAN_BLIZZARD, -11179.080f, -1905.279f, 232.008f, 2.9f,
                                        TEMPSUMMON_TIMED_DESPAWN, 25000);
          if (Blizzard) {
      ...
      if (!ElementalsSpawned && HealthBelowPct(40)) {
        ...
        ElementalOne = me->SummonCreature(NPC_WATER_ELEMENTAL, -11168.1f, -1939.29f, 232.092f, 1.46f,
                                          TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 90000);
        ElementalTwo = me->SummonCreature(NPC_WATER_ELEMENTAL, -11138.2f, -1915.38f, 232.092f, 3.00f,
                                          TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 90000);
        ElementalThree = me->SummonCreature(NPC_WATER_ELEMENTAL, -11161.7f, -1885.36f, 232.092f, 4.59f,
                                            TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 90000);
        ElementalFour = me->SummonCreature(NPC_WATER_ELEMENTAL, -11192.4f, -1909.36f, 232.092f, 6.19f,
                                           TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 90000);
    ...
    void SpellHit(Unit * /*pAttacker*/, const SpellEntry *Spell) {
      ...
      if ((Spell->Effect[0] != SPELL_EFFECT_INTERRUPT_CAST && Spell->Effect[1] != SPELL_EFFECT_INTERRUPT_CAST &&
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_shade_of_aranAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_aran_elementalAI(pCreature); }
};
