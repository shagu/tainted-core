...
enum OperaEvents { EVENT_OZ = 1, EVENT_HOOD = 2, EVENT_RAJ = 3 };
...
#define ERROR_INST_DATA(a)                                                                                             \
  sLog.outError(                                                                                                       \
      "OSCR: Instance Data for Karazhan not set properly. Encounter for Creature Entry %u may not work properly.",     \
      a->GetEntry());
#endif
