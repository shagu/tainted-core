...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_high_inquisitor_fairbanksAI(pCreature); }
};

void AddSC_boss_high_inquisitor_fairbanks() { new boss_high_inquisitor_fairbanks(); }
