...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_azshir_the_sleeplessAI(pCreature); }
};

void AddSC_boss_azshir_the_sleepless() { new boss_azshir_the_sleepless(); }
