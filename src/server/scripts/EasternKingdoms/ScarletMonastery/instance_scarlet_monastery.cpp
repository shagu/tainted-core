...
public:
  ...
  struct instance_scarlet_monasteryAI : public ScriptedInstance {
    instance_scarlet_monasteryAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_scarlet_monasteryAI(pMap); }
};
void AddSC_instance_scarlet_monastery() { new instance_scarlet_monastery(); }
