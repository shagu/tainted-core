...
//#define SPELL_CONFL_SPEED         22587       //8% increase speed, value 22587 from SPELL_CONFLAGRATION mains that
//spell?
...
static Locations FlightPoint[] = {
    {1754.00f, 1346.00f, 17.50f}, {1765.00f, 1347.00f, 19.00f}, {1784.00f, 1346.80f, 25.40f},
    {1803.30f, 1347.60f, 33.00f}, {1824.00f, 1350.00f, 42.60f}, {1838.80f, 1353.20f, 49.80f},
    {1852.00f, 1357.60f, 55.70f}, {1861.30f, 1364.00f, 59.40f}, {1866.30f, 1374.80f, 61.70f},
    {1864.00f, 1387.30f, 63.20f}, {1854.80f, 1399.40f, 64.10f}, {1844.00f, 1406.90f, 64.10f},
    {1824.30f, 1411.40f, 63.30f}, {1801.00f, 1412.30f, 60.40f}, {1782.00f, 1410.10f, 55.50f},
    {1770.50f, 1405.20f, 50.30f}, {1765.20f, 1400.70f, 46.60f}, {1761.40f, 1393.40f, 41.70f},
    {1759.10f, 1386.70f, 36.60f}, {1757.80f, 1378.20f, 29.00f}, {1758.00f, 1367.00f, 19.51f}};
...
static const char *Text[] = {"Horseman rise...", "Your time is nigh...", "You felt death once...", "Now, know demise!"};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_wisp_invisAI(pCreature); }
};
...
public:
  ...
  struct mob_headAI : public ScriptedAI {
    ...
    void Disappear(); // we must set returned=true(this will prevent from "body calls head" while head flying to body),
                      // see function below
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_headAI(pCreature); }
};
...
public:
  ...
  struct boss_headless_horsemanAI : public ScriptedAI {
    ...
    void MovementInform(uint32 type, uint32 i) {
      ...
      case 1: {
        if (Creature *smoke =
                me->SummonCreature(HELPER, Spawn[1].x, Spawn[1].y, Spawn[1].z, 0, TEMPSUMMON_TIMED_DESPAWN, 20000))
    ...
    void UpdateAI(const uint32 diff) {
      if (withhead) {
        ...
        case 1:
          ...
          if (burn <= diff) {
            if (Creature *flame =
                    me->SummonCreature(HELPER, Spawn[0].x, Spawn[0].y, Spawn[0].z, 0, TEMPSUMMON_TIMED_DESPAWN, 17000))
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_headless_horsemanAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_pulsing_pumpkinAI(pCreature); }
};
...
public:
  ...
  bool OnGossipHello(Player *pPlayer, GameObject *soil) override {
    ...
    if (Creature *horseman = soil->SummonCreature(HH_MOUNTED, FlightPoint[20].x, FlightPoint[20].y, FlightPoint[20].z,
                                                  0, TEMPSUMMON_MANUAL_DESPAWN, 0)) {
