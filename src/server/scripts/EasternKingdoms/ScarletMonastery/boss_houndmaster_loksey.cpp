...
enum eEnums { SAY_AGGRO = -1189021, SPELL_SUMMONSCARLETHOUND = 17164, SPELL_BLOODLUST = 6742 };
...
public:
  ...
  struct boss_houndmaster_lokseyAI : public ScriptedAI {
    ...
    void Reset() { BloodLust_Timer = 20000; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_houndmaster_lokseyAI(pCreature); }
};
