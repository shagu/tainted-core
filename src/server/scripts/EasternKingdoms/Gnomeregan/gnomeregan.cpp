...
const Position SpawnPosition[] = {{-557.630f, -114.514f, -152.209f, 0.641f}, {-555.263f, -113.802f, -152.737f, 0.311f},
                                  {-552.154f, -112.476f, -153.349f, 0.621f}, {-548.692f, -111.089f, -154.090f, 0.621f},
                                  {-546.905f, -108.340f, -154.877f, 0.729f}, {-547.736f, -105.154f, -155.176f, 0.372f},
                                  {-547.274f, -114.109f, -153.952f, 0.735f}, {-552.534f, -110.012f, -153.577f, 0.747f},
                                  {-550.708f, -116.436f, -153.103f, 0.679f}, {-554.030f, -115.983f, -152.635f, 0.695f},
                                  {-494.595f, -87.516f, 149.116f, 3.344f},   {-493.349f, -90.845f, -148.882f, 3.717f},
                                  {-491.995f, -87.619f, -148.197f, 3.230f},  {-490.732f, -90.739f, -148.091f, 3.230f},
                                  {-490.554f, -89.114f, -148.055f, 3.230f},  {-495.240f, -90.808f, -149.493f, 3.238f},
...
public:
  ...
  struct npc_blastmaster_emi_shortfuseAI : public npc_escortAI {
    ...
    void CaveDestruction(bool bBool) {
      ...
      for (std::list<uint64>::const_iterator itr = GoSummonList.begin(); itr != GoSummonList.end(); ++itr) {
        if (GameObject *pGo = GameObject::GetGameObject(*me, *itr)) {
          if (pGo) {
            if (Creature *trigger =
                    pGo->SummonTrigger(pGo->GetPositionX(), pGo->GetPositionY(), pGo->GetPositionZ(), 0, 1)) {
    ...
    void Summon(uint8 uiCase) {
      ...
      case 8:
        ...
        break;
      case 9:
        if (Creature *pGrubbis =
                me->SummonCreature(NPC_GRUBBIS, SpawnPosition[15], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 1800000))
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_blastmaster_emi_shortfuseAI(pCreature); }
...
public:
  ...
  struct boss_grubbisAI : public ScriptedAI {
    boss_grubbisAI(Creature *pCreature) : ScriptedAI(pCreature) { SetDataSummoner(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_grubbisAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_kernobeeAI(pCreature); }
