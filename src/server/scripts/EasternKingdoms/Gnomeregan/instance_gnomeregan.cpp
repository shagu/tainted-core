...
public:
  ...
  struct instance_gnomereganAI : public ScriptedInstance {
    instance_gnomereganAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_gnomereganAI(pMap); }
};
void AddSC_instance_gnomeregan() { new instance_gnomeregan(); }
