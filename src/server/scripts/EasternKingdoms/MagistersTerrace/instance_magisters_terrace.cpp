...
public:
  ...
  struct instance_magisters_terraceAI : public ScriptedInstance {
    instance_magisters_terraceAI(Map *pMap) : ScriptedInstance(pMap) { Initialize(); }
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_magisters_terraceAI(pMap); }
};
void AddSC_instance_magisters_terrace() { new instance_magisters_terrace(); }
