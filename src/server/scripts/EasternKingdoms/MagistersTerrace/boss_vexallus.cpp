...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_vexallusAI>(pCreature); };
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_pure_energyAI(pCreature); };
};
