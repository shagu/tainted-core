...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_archmage_arugalAI(pCreature); }
};

void AddSC_boss_archmage_arugal() { new boss_archmage_arugal(); }
