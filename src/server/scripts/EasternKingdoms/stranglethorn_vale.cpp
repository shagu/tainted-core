...
public:
  ...
  struct mob_yennikuAI : public ScriptedAI {
    mob_yennikuAI(Creature *c) : ScriptedAI(c) { bReset = false; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_yennikuAI(pCreature); }

  /*######
  ##
  ######*/
};
void AddSC_stranglethorn_vale() { new mob_yenniku(); }
