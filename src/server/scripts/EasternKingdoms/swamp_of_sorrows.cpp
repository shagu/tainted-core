...
public:
  ...
  struct npc_galen_goodwardAI : public npc_escortAI {
    ...
    void Reset() { m_uiPostEventTimer = 0; }

    void EnterCombat(Unit *) { DoScriptText(RAND(GILAN_SAY_UNDER_ATTACK_1, GILAN_SAY_UNDER_ATTACK_2), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_galen_goodwardAI(pCreature); }
};
