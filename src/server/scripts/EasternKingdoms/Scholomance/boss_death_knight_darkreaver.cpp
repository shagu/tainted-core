...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_death_knight_darkreaverAI(pCreature); }
};

void AddSC_boss_death_knight_darkreaver() { new boss_death_knight_darkreaver(); }
