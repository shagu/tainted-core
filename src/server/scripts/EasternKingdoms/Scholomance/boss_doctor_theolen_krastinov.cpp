...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_doctor_theolen_krastinovAI(pCreature); }
};

void AddSC_boss_theolenkrastinov() { new boss_doctor_theolen_krastinov(); }
