...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_shadow_hunter_voshgajinAI(pCreature); }
};

void AddSC_boss_shadowvosh() { new boss_shadow_hunter_voshgajin(); }
