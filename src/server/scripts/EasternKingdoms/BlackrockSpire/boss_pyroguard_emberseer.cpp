...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_pyroguard_emberseerAI(pCreature); }
};

void AddSC_boss_pyroguard_emberseer() { new boss_pyroguard_emberseer(); }
