...
public:
  ...
  struct boss_magistrate_barthilasAI : public ScriptedAI {
    ...
    void JustDied(Unit * /*Killer*/) { me->SetDisplayId(MODEL_HUMAN); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_magistrate_barthilasAI(pCreature); }
};

void AddSC_boss_magistrate_barthilas() { new boss_magistrate_barthilas(); }
