...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_cannon_master_willeyAI(pCreature); }
};

void AddSC_boss_cannon_master_willey() { new boss_cannon_master_willey(); }