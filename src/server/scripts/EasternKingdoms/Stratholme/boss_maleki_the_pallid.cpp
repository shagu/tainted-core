...
public:
  ...
  struct boss_maleki_the_pallidAI : public ScriptedAI {
    boss_maleki_the_pallidAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)me->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_maleki_the_pallidAI(pCreature); }
};

void AddSC_boss_maleki_the_pallid() { new boss_maleki_the_pallid(); }
