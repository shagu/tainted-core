...
Location m_afAmbushSpawn[] = {{191.296204f, -2839.329346f, 107.388f}, {70.972466f, -2848.674805f, 109.459f}};

Location m_afAmbushMoveTo[] = {{166.630386f, -2824.780273f, 108.153f}, {70.886589f, -2874.335449f, 116.675f}};
...
public:
  ...
  struct npc_00x09hlAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 uiPointId) {
      ...
      case 26:
        ...
        for (uint8 i = 0; i < 3; ++i)
          me->SummonCreature(NPC_MARAUDING_OWL, 178.111f, -3801.58f, 128.37f, 0.0f, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN,
                             30000);
        break;
      case 43:
        DoScriptText(SAY_OOX_AMBUSH, me);
        for (uint8 i = 0; i < 3; ++i)
          me->SummonCreature(NPC_VILE_AMBUSHER, -116.258f, -4211.96f, 121.878f, 0.0f,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_00x09hlAI(pCreature); }
...
public:
  ...
  struct npc_rinjiAI : public npc_escortAI {
    ...
    void DoSpawnAmbush(bool bFirst) {
      ...
      me->SummonCreature(NPC_RANGER, m_afAmbushSpawn[m_iSpawnId].m_fX, m_afAmbushSpawn[m_iSpawnId].m_fY,
                         m_afAmbushSpawn[m_iSpawnId].m_fZ, 0.0f, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 60000);

      for (int i = 0; i < 2; ++i) {
        me->SummonCreature(NPC_OUTRUNNER, m_afAmbushSpawn[m_iSpawnId].m_fX, m_afAmbushSpawn[m_iSpawnId].m_fY,
                           m_afAmbushSpawn[m_iSpawnId].m_fZ, 0.0f, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 60000);
      }
    }
    ...
    void JustSummoned(Creature *pSummoned) {
      ...
      pSummoned->GetMotionMaster()->MovePoint(0, m_afAmbushMoveTo[m_iSpawnId].m_fX, m_afAmbushMoveTo[m_iSpawnId].m_fY,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_rinjiAI(pCreature); }
