...
enum eMausoleum { QUEST_ULAG = 1819, NPC_ULAG = 6390, GO_TRIGGER = 104593, GO_DOOR = 176594 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_calvin_montagueAI(pCreature); }
