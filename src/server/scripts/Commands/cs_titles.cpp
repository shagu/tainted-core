...
public:
  ...
  std::vector<ChatCommand> GetCommands() const override {
    ...
    static std::vector<ChatCommand> commandTable = {{"titles", SEC_GAMEMASTER, false, nullptr, "", titlesCommandTable}};
    return commandTable;
  }
  ...
  static bool HandleTitlesCurrentCommand(ChatHandler *handler, const char *args) {
    ...
    handler->PSendSysMessage(LANG_TITLE_CURRENT_RES, id, titleInfo->name[handler->GetSession()->GetSessionDbcLocale()],
                             tNameLink.c_str());
