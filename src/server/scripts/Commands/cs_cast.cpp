...
public:
  ...
  std::vector<ChatCommand> GetCommands() const override {
    static std::vector<ChatCommand> castCommandTable = {{"back", SEC_GAMEMASTER, false, &HandleCastBackCommand, ""},
    ...
    static std::vector<ChatCommand> commandTable = {{"cast", SEC_GAMEMASTER, false, nullptr, "", castCommandTable}};
    return commandTable;
  }
