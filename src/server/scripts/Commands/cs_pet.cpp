...
public:
  ...
  std::vector<ChatCommand> GetCommands() const override {
    static std::vector<ChatCommand> petCommandTable = {{"create", SEC_GAMEMASTER, false, HandleCreatePetCommand, ""},
                                                       ...
                                                       {NULL, 0, false, NULL, ""}};
    static std::vector<ChatCommand> commandTable = {{"pet", SEC_MODERATOR, true, nullptr, "", petCommandTable}};
    return commandTable;
  }
