...
public:
  ...
  std::vector<ChatCommand> GetCommands() const override {
    ...
    static std::vector<ChatCommand> commandTable = {{"reset", SEC_ADMINISTRATOR, true, nullptr, "", resetCommandTable}};
    return commandTable;
  }
  ...
  static bool HandleResetSpellsCommand(ChatHandler *handler, const char *args) {
    ...
    if (player) {
      ...
      CharacterDatabase.PExecute("UPDATE characters SET at_login = at_login | '%u' WHERE guid = '%u'",
                                 uint32(AT_LOGIN_RESET_SPELLS), GUID_LOPART(playerGUID));
  ...
  static bool HandleResetTalentsCommand(ChatHandler *handler, const char *args) {
    ...
    if (player) {
      ...
      CharacterDatabase.PExecute("UPDATE characters SET at_login = at_login | '%u' WHERE guid = '%u'",
                                 uint32(AT_LOGIN_RESET_TALENTS), GUID_LOPART(playerGUID));
  ...
  static bool HandleResetAllCommand(ChatHandler *handler, const char *args) {
    ...
    CharacterDatabase.PExecute("UPDATE characters SET at_login = at_login | '%u' WHERE (at_login & '%u') = '0'",
                               atLogin, atLogin);
