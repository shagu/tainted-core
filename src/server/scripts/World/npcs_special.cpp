...
npc_guardian                100%    guardianAI used to prevent players from accessing off-limits areas. Not in use by
SD2 npc_garments_of_quests       80%    NPC's related to all Garments of-quests 5621, 5624, 5625, 5648, 5650
npc_injured_patient         100%    patients for triage-quests (6622 and 6624)
npc_doctor                  100%    Gustaf Vanhowzen and Gregory Victor, quest 6622 and 6624 (Triage)
npc_mount_vendor            100%    Regular mount vendors all over the world. Display gossip if player doesn't meet the
requirements to buy npc_rogue_trainer            80%    Scripted trainers, so they are able to offer item 17126 for
class quest 6681 npc_sayge                   100%    Darkmoon event fortune teller, buff player based on answers given
...
enum { NPC_EXPLOSIVE_SHEEP = 2675, SPELL_EXPLOSIVE_SHEEP = 4050 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_explosive_sheepAI(pCreature); }
};
...
#define GOSSIP_ITEM_GRANT                                                                                              \
  "You have thought well, spirit. I ask you to grant me the strength of your body and the strength of your heart."
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_chicken_cluckAI(pCreature); }
};
...
public:
  ...
  struct npc_dancing_flamesAI : public ScriptedAI {
    ...
    void ReceiveEmote(Player *pPlayer, uint32 emote) {
      if (me->IsWithinLOS(pPlayer->GetPositionX(), pPlayer->GetPositionY(), pPlayer->GetPositionZ()) &&
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_dancing_flamesAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_doctorAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_injured_patientAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_garments_of_questsAI(pCreature); }
};
...
public:
  ...
  struct npc_guardianAI : public ScriptedAI {
    ...
    void Reset() { me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE); }

    void EnterCombat(Unit * /*who*/) { me->MonsterYell(SAY_AGGRO, LANG_UNIVERSAL, 0); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_guardianAI(pCreature); }
};
...
public:
  ...
  bool OnGossipHello(Player *pPlayer, Creature *pCreature) {
    ...
    if (pCreature->CanTrainAndResetTalentsOf(pPlayer))
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, GOSSIP_HELLO_ROGUE1, GOSSIP_SENDER_MAIN,
                               GOSSIP_OPTION_UNLEARNTALENTS);

    if (pPlayer->getClass() == CLASS_ROGUE && pPlayer->getLevel() >= 24 && !pPlayer->HasItemCount(17126, 1) &&
...
public:
...

  {
    ...
    if (pPlayer->HasSpellCooldown(SPELL_INT) || pPlayer->HasSpellCooldown(SPELL_ARM) ||
        pPlayer->HasSpellCooldown(SPELL_DMG) || pPlayer->HasSpellCooldown(SPELL_RES) ||
        pPlayer->HasSpellCooldown(SPELL_STR) || pPlayer->HasSpellCooldown(SPELL_AGI) ||
        pPlayer->HasSpellCooldown(SPELL_STM) || pPlayer->HasSpellCooldown(SPELL_SPI))
  ...
  void SendAction(Player *pPlayer, Creature *pCreature, uint32 action) {
    switch (action) {
    case GOSSIP_ACTION_INFO_DEF + 1:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE1, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 2);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE2, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 3);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE3, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 4);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE4, GOSSIP_SENDER_MAIN,
                               GOSSIP_ACTION_INFO_DEF + 5);
      pPlayer->SEND_GOSSIP_MENU(7340, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 2:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE5, GOSSIP_SENDER_MAIN + 1,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE6, GOSSIP_SENDER_MAIN + 2,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE7, GOSSIP_SENDER_MAIN + 3,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->SEND_GOSSIP_MENU(7341, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 3:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE8, GOSSIP_SENDER_MAIN + 4,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE9, GOSSIP_SENDER_MAIN + 5,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE10, GOSSIP_SENDER_MAIN + 2,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->SEND_GOSSIP_MENU(7361, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 4:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE11, GOSSIP_SENDER_MAIN + 6,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE12, GOSSIP_SENDER_MAIN + 7,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE13, GOSSIP_SENDER_MAIN + 8,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->SEND_GOSSIP_MENU(7362, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF + 5:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE14, GOSSIP_SENDER_MAIN + 5,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE15, GOSSIP_SENDER_MAIN + 4,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE16, GOSSIP_SENDER_MAIN + 3,
                               GOSSIP_ACTION_INFO_DEF);
      pPlayer->SEND_GOSSIP_MENU(7363, pCreature->GetGUID());
      break;
    case GOSSIP_ACTION_INFO_DEF:
      pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_SENDACTION_SAYGE17, GOSSIP_SENDER_MAIN,
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_steam_tonkAI(pCreature); }
};
...
public:
  ...
  struct npc_tonk_mineAI : public ScriptedAI {
    npc_tonk_mineAI(Creature *c) : ScriptedAI(c) { me->SetReactState(REACT_PASSIVE); }

    uint32 ExplosionTimer;

    void Reset() { ExplosionTimer = 3000; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_tonk_mineAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_brewfest_revelerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_winter_revelerAI(pCreature); }
};
...
public:
  ...
  struct npc_training_dummyAI : public ScriptedAI {
    npc_training_dummyAI(Creature *c) : ScriptedAI(c) { SetCombatMovement(false); }
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_training_dummyAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_force_of_nature_treantsAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_snake_trap_serpentsAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_mojoAI(pCreature); }
};
...
public:
    ...
    void EscapeIntoVoid(bool handleQuest) {
      if (handleQuest) {
        if (GameObject *container = GetClosestGameObjectWithEntry(me, GO_CONTAINMENT_COFFER, 5.0f)) {
          if (Creature *trigger =
                  me->SummonTrigger(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 0, 10000)) {
  ...
  CreatureAI *GetAI(Creature *_Creature) const { return new mob_rift_spawnAI(_Creature); }
};
...
public:
    ...
    void Reset() {
      if (!initialized && me->HasUnitTypeMask(~0)) {
        if (Unit *owner = ((TempSummon *)me)->GetSummoner()) {
          ...
          me->CastSpell(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 22703, false, NULL, NULL,
                        owner->GetGUID()); // Inferno Effect (dmg + stun)
  ...
  CreatureAI *GetAI(Creature *_Creature) const { return new mob_inferno_infernalAI(_Creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_barmaidAI(pCreature); }
};
