...
public:
  ...
  struct boss_emerissAI : public ScriptedAI {
    ...
    void Aggro(Unit * /*pWho*/) { DoScriptText(SAY_AGGRO, me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_emerissAI(pCreature); }
};

void AddSC_boss_emeriss() { new boss_emeriss(); }
