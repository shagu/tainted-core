...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_ysondreAI(pCreature); }
};
...
public:
  ...
  struct mob_dementeddruidsAI : public ScriptedAI {
    ...
    void Reset() { m_uiMoonFire_Timer = 3000; }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_dementeddruidsAI(pCreature); }
};
