...
CombatAI should be organized better for future. SDCategory: Guards EndScriptData */
...
void SendDefaultMenu_guard_shattrath(Player *player, Creature *pCreature, uint32 action) {
  ...
  case GOSSIP_ACTION_INFO_DEF + 7: // Battlemaster
    player->ADD_GOSSIP_ITEM(0, GOSSIP_TEXT_BATTLEMASTERALLIANCE, GOSSIP_SENDER_SEC_BATTLEINFO,
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new guardAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new guardAI_orgrimmar(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new guard_shattrath_aldorAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new guard_shattrath_scryerAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new guardAI_stormwind(pCreature); }
