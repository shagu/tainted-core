...
public:
      ...
      if (me->IsWithinMeleeRange(me->GetVictim())) {
        ...
        if (!me->IsNonMeleeSpellCast(false)) {
          ...
          if (info)
            ...
            info = SelectSpell(me->GetVictim(), 0, 0, SELECT_TARGET_ANY_ENEMY, 0, 0, NOMINAL_MELEE_RANGE, 0,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new generic_creatureAI(pCreature); }
};
