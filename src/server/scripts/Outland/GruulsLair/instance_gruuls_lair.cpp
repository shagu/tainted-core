...
public:
  ...
  struct instance_gruuls_lairAI : public ScriptedInstance {
    instance_gruuls_lairAI(Map *map) : ScriptedInstance(map) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_gruuls_lairAI(pMap); }
};
