...
SDName: Netherstorm
SD%Complete: 90
SDComment: Quest support: 10337, 10438, 10652 (special flight paths),
10299,10321,10322,10323,10329,10330,10338,10365(Shutting Down Manaforge), 10198, 10191, 10924, 10221, 10310. SDCategory:
Netherstorm EndScriptData */
...
//@todo clean up this workaround when Oregon adds support to do it properly (with gossip selections instead of instant
//summon)
...
enum { THROW_DYNAMITE = 35276, BOOM_BOT = 19692, BOOM_BOT_TARGET = 20392 };
...
#define NEGATRON_TEXT                                                                                                  \
  "HAHAHA! YOUR FEEBLE ROCKET IS DESTROYED! I'LL RETURN LATER TO FINISH OFF THE REST OF YOUR PUNY TOWN!"
...
#define KAYLAN_TEXT_1                                                                                                  \
  "My heart has been filled with hate since our sworn enemies were allowed into our city. I knew the one known as "    \
  "Voren'thal before he was called a Seer. It was by his hand that my brother was slain."
#define KAYLAN_TEXT_2                                                                                                  \
  "I turned that hate on the Illidari and the Burning Legion... but they weren't the ones who betrayed us. We were "   \
  "the naaru's chosen! We lived and died for them!"
#define KAYLAN_TEXT_3                                                                                                  \
  "Once the hatred in my heart became focused, everything became clear to me. Shattrath must be destroyed and the "    \
  "naaru with it."
#define KAYLAN_TEXT_4 "You're wrong, Adyen. My mind has never been clearer."
#define KAYLAN_TEXT_5 "Yes... master."
#define ADYEN_TEXT_3                                                                                                   \
  "Socrethar is clouding your mind, Kaylaan! You do not mean these words! I remember training you when you were but "  \
  "a youngling. Your will was stron even then!"
...
#define ADYEN_TEXT_2                                                                                                   \
  "We may be few, Socrethar, but our faith is strong. Something you will never understand. Now that custom has been "  \
  "served, prepare to meet your end."
...
#define GOSSIP_ITEM_MARID_EVENT_START                                                                                  \
  "Wind Trader Marid. I've returned with more information on the nether drakes. I'm prepared to be your business "     \
  "partner, and for an extra sum, I'll take care of that troublesome elf and her human friend."
#define MARID_START_SAY -1910190
#define MARID_SAY_1                                                                                                    \
  "You didn't really think I'd do business with you again, did you? Sometimes, the best way to return to "             \
  "profitability is to know when to cut your losses."
...
#define ESCORT_DEMOLITIONIST_1                                                                                         \
  "By the second sun of K'aresh, look at this place! I can only imagine what Salhadaar is planning. Come on, let's "   \
  "keep going."
...
#define AMEER_TEXT_2                                                                                                   \
  "Those fools! What have they done! What horrors \
do they hold? And for what purpose? I will need \
your help again, hero. Help us. Help your people."

#define PRISONER_TEXT                                                                                                  \
  "Commander... I am not long for this world... \
...
#define YA_SIX_WARN_ARCONUS_TEXT                                                                                       \
  "Arconus is close. I can feel him. Take the northwest passage. He should be just up and around the corner. Be "      \
  "ready to battle!"
#define YA_SIX_EXIT_CAVE_TEXT                                                                                          \
  "This is the wrong way. Arconus is at the other end of the mine. You're not chickening out, are you, fleshling? I "  \
...
public:
  ...
  struct npc_manaforge_control_consoleAI : public ScriptedAI {
    ...
    void DoWaveSpawnForCreature(Creature *creature) {
      ...
      case ENTRY_BNAAR_C_CONSOLE:
        if (rand() % 2) {
          add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2933.68f, 4162.55f, 164.00f, 1.60f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 2927.36f, 4212.97f, 164.00f);
        } else {
          add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2927.36f, 4212.97f, 164.00f, 4.94f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
        ...
        break;
      case ENTRY_CORUU_C_CONSOLE:
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2445.21f, 2765.26f, 134.49f, 3.93f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2424.21f, 2740.15f, 133.81f);
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2429.86f, 2731.85f, 134.53f, 1.31f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
        ...
        break;
      case ENTRY_DURO_C_CONSOLE:
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2986.80f, 2205.36f, 165.37f, 3.74f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2985.15f, 2197.32f, 164.79f);
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2952.91f, 2191.20f, 165.32f, 0.22f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
      ...
      case ENTRY_ARA_C_CONSOLE:
        if (rand() % 2) {
          add = me->SummonCreature(ENTRY_ARA_TECH, 4035.11f, 4038.97f, 194.27f, 2.57f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4003.42f, 4040.19f, 193.49f);
          add = me->SummonCreature(ENTRY_ARA_TECH, 4033.66f, 4036.79f, 194.28f, 2.57f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4003.42f, 4040.19f, 193.49f);
          add = me->SummonCreature(ENTRY_ARA_TECH, 4037.13f, 4037.30f, 194.23f, 2.57f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4003.42f, 4040.19f, 193.49f);
        } else {
          add = me->SummonCreature(ENTRY_ARA_TECH, 3099.59f, 4049.30f, 194.22f, 0.05f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4028.01f, 4035.17f, 193.59f);
          add = me->SummonCreature(ENTRY_ARA_TECH, 3999.72f, 4046.75f, 194.22f, 0.05f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4028.01f, 4035.17f, 193.59f);
          add = me->SummonCreature(ENTRY_ARA_TECH, 3996.81f, 4048.26f, 194.22f, 0.05f,
                                   TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
          if (add)
            add->GetMotionMaster()->MovePoint(0, 4028.01f, 4035.17f, 193.59f);
        }
    ...
    void DoFinalSpawnForCreature(Creature *creature) {
      switch (creature->GetEntry()) {
      case ENTRY_BNAAR_C_CONSOLE:
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2946.52f, 4201.42f, 163.47f, 3.54f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2927.49f, 4192.81f, 163.00f);
        break;
      case ENTRY_CORUU_C_CONSOLE:
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2453.88f, 2737.85f, 133.27f, 2.59f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2433.96f, 2751.53f, 133.85f);
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2441.62f, 2735.32f, 134.49f, 1.97f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2433.96f, 2751.53f, 133.85f);
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2450.73f, 2754.50f, 134.49f, 3.29f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2433.96f, 2751.53f, 133.85f);
        break;
      case ENTRY_DURO_C_CONSOLE:
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2956.18f, 2202.85f, 165.32f, 5.45f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2972.27f, 2193.22f, 164.48f);
        add = me->SummonCreature(ENTRY_SUNFURY_TECH, 2975.30f, 2211.50f, 165.32f, 4.55f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2972.27f, 2193.22f, 164.48f);
        add = me->SummonCreature(ENTRY_SUNFURY_PROT, 2965.02f, 2217.45f, 164.16f, 4.96f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 2972.27f, 2193.22f, 164.48f);
        break;
      case ENTRY_ARA_C_CONSOLE:
        add = me->SummonCreature(ENTRY_ARA_ENGI, 3994.51f, 4020.46f, 192.18f, 0.91f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
          add->GetMotionMaster()->MovePoint(0, 4008.35f, 4035.04f, 192.70f);
        add = me->SummonCreature(ENTRY_ARA_GORKLONN, 4021.56f, 4059.35f, 193.59f, 4.44f,
                                 TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 120000);
        if (add)
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_manaforge_control_consoleAI(pCreature); }
};
...
public:
  ...
  struct npc_commander_dawnforgeAI : public ScriptedAI {
    ...
    Creature *SelectCreatureInGrid(uint32 entry, float range) {
      ...
      Oregon::CreatureLastSearcher<Oregon::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(
          me, pCreature, creature_check);
      TypeContainerVisitor<Oregon::CreatureLastSearcher<Oregon::NearestCreatureEntryWithLiveStateInObjectRangeCheck>,
                           GridTypeMapContainer>
          creature_searcher(searcher);
      cell.Visit(pair, creature_searcher, *(me->GetMap()), *me, me->GetGridActivationRange());

      return pCreature;
    }

    void JustSummoned(Creature *summoned) { pathaleonGUID = summoned->GetGUID(); }
    ...
    void UpdateAI(const uint32 diff) {
      ...
      case 4:
        ...
        me->SummonCreature(CreatureEntry[2][0], 2325.851563f, 2799.534668f, 133.084229f, 6.038996f,
                           TEMPSUMMON_TIMED_DESPAWN, 90000);
        ++Phase;
        Phase_Timer = 500;
        break;
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_commander_dawnforgeAI(pCreature); }
};
...
public:
  ...
  struct npc_phase_hunterAI : public ScriptedAI {
    ...
    void SpellHit(Unit * /*caster*/, const SpellEntry * /*spell*/) { DoCast(me, SPELL_MATERIALIZE); }
  ...
  CreatureAI *GetAI(Creature *c) const { return new npc_phase_hunterAI(c); }
};
...
public:
  ...
  struct npc_bessyAI : public npc_escortAI {
    ...
    void WaypointReached(uint32 i) {
      ...
      switch (i) {
      case 3: // first spawn
        me->SummonCreature(SPAWN_FIRST, 2449.67f, 2183.11f, 96.85f, 6.20f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_FIRST, 2449.53f, 2184.43f, 96.36f, 6.27f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_FIRST, 2449.85f, 2186.34f, 97.57f, 6.08f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        break;

      case 7:
        me->SummonCreature(SPAWN_SECOND, 2309.64f, 2186.24f, 92.25f, 6.06f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        me->SummonCreature(SPAWN_SECOND, 2309.25f, 2183.46f, 91.75f, 6.22f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                           25000);
        break;
    ...
    void Reset() { me->RestoreFaction(); }
  };

  CreatureAI *GetAI(Creature *pCreature) const { return new npc_bessyAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_maxx_a_million_escortAI(pCreature); }
...
public:
    ...
    void UpdateAI(const uint32 uiDiff) {
      if (uiCheckTimer <= uiDiff) {
        if (Creature *pWarp = me->FindNearestCreature(NPC_WARP_CHASER, 9.0f, false)) {
          if (pWarp->GetGUID() != uiWarpGUID &&
              CAST_PLR(me->GetOwner())->GetQuestStatus(QUEST_BLOODY) == QUEST_STATUS_INCOMPLETE) {
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_zeppitAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_dr_boomAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_boom_botAI(pCreature); }
};
...
public:
  ...
  struct npc_drijyaAI : public npc_escortAI {
    ...
    void SpawnTrooper() {
      ++Count;
      me->SummonCreature(NPC_TROOPER, 3025.752f, 2715.122f, 113.758f, 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                         10000);
    }

    void SpawnDestroyer() {
      me->SummonCreature(NPC_DESTROYER, 3019.741f, 2720.757f, 115.189f, 2.5f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                         10000);
    }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_drijyaAI(pCreature); }
  ...
  struct npc_mana_wraithAI : public ScriptedAI {
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (manadevour_timer <= diff) {
        ...
        manadevour_timer -= diff;

      DoMeleeAttackIfReady();
    }
  };

  CreatureAI *GetAI(Creature *pCreature) const { return new npc_mana_wraithAI(pCreature); }
};
  ...
  struct npc_warp_abberationAI : public ScriptedAI {
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (warpstorm_timer <= diff) {
        ...
        warpstorm_timer -= diff;

      DoMeleeAttackIfReady();
    }
  };

  CreatureAI *GetAI(Creature *pCreature) const { return new npc_warp_abberationAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_scrapped_fel_reaverAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_mana_seekerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_mageslayerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_naberiusAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_doctor_vomisaAI(pCreature); }

  bool OnQuestAccept(Player *pPlayer, Creature *pCreature, const Quest *pQuest) override {
    if (pQuest->GetQuestId() == QUEST_YOU_ROBOT) {
      pCreature->SummonCreature(NPC_NEGATRON, 3113.6f, 3316.8f, 109.4f, 1.84f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                                60000);
    }
    return true;
  }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_negatronAI(pCreature); }
};
...
public:
  ...
  struct npc_farahlon_lasherAI : public ScriptedAI {
    ...
    void SpellHit(Unit *Hitter, const SpellEntry *Spellkind) {
      if (Spellkind->Id == 35772 && !spellHit) {
        me->SummonCreature(NPC_MUTATED_FARAHLON_LASHER, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 0,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_farahlon_lasherAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_talbuk_doeAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_talbuk_sireAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_warp_monstrosityAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new gehenna_triggerAI(pCreature); }
};
...
public:
  ...
  struct legion_aldor_triggerAI : public ScriptedAI {
    ...
    void MoveInLineOfSight(Unit *pWho) {
      if (Player *plWho = pWho->GetCharmerOrOwnerPlayerOrPlayerItself()) {
        if (plWho->GetQuestStatus(QUEST_DEATHBLOW_TO_THE_LEGION) == QUEST_STATUS_INCOMPLETE &&
            plWho->GetDistance(me) < 10.0f) {
          switch (me->GetEntry()) {
          case 61020:
            if (!summoned) {
              me->SummonCreature(NPC_ADYEN_THE_LIGHTWARDEN, 4804.8f, 3772.0f, 210.5f, 5.3f, TEMPSUMMON_MANUAL_DESPAWN,
                                 0);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new legion_aldor_triggerAI(pCreature); }
};
...
public:
  ...
  struct npc_socretharAI : public ScriptedAI {
    ...
    void JustSummoned(Creature *summoned) { summoned->GetMotionMaster()->MovePath(601601609, false); }

    void MoveInLineOfSight(Unit *pWho) {
      if (Player *plWho = pWho->GetCharmerOrOwnerPlayerOrPlayerItself()) {
        if (plWho->GetQuestStatus(QUEST_TURNING_POINT) == QUEST_STATUS_INCOMPLETE && plWho->GetDistance(me) < 25.0f &&
            plWho->HasItemCount(30259, 1, false)) {
          switch (me->GetEntry()) {
          case 20132:
            if (!scryer_start) {
              me->SetFaction(14);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_socretharAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new adyen_lightwardenAI(pCreature); }
...
public:
  ...
  struct npc_kaylaanAI : public ScriptedAI {
    ...
    void JustSummoned(Creature *summoned) { summoned->GetMotionMaster()->MovePoint(0, 4943.6f, 3839.6f, 211.5f); }
      ...
      if (!UpdateVictim()) {
        ...
        if (conv5 == true && !summon_ishanah) {
          if (summon_ishanah_timer <= diff) {
            me->SummonCreature(NPC_ISHANAH, 4907.5f, 3823.1f, 211.4f, 0.5f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                               120000);
            summon_ishanah = true;
          } else
            summon_ishanah_timer -= diff;
        }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_kaylaanAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_socre_helperAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new legion_beam_triggerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new arena_event_controllerAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_windtrader_maridAI(pCreature); }
  ...
  struct npc_salhadaarAI : public ScriptedAI {
    ...
    void UpdateAI(const uint32 diff) {
      ...
      if (arcaneflux_timer <= diff) {
        ...
        arcaneflux_timer -= diff;

      DoMeleeAttackIfReady();
    }
  };

  CreatureAI *GetAI(Creature *pCreature) const { return new npc_salhadaarAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_energy_ballAI(pCreature); }
};
    ...
    void WaypointReached(uint32 i) {
      ...
      case 17:
        ...
        if (Creature *dimension = me->FindNearestCreature(21035, 25.0f, true)) {
          ...
          me->SummonCreature(NPC_DIMENSIUS, 3936.4f, 2003.6f, 255.6f, 0.9f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
                             60000);
        }
        break;
      case 18:
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_dimensius_devourerAI(pCreature); }
};
...
public:
  ...
  struct npc_commander_ameerAI : public ScriptedAI {
    ...
    void HandlePhaseComplete() {
      ...
      case 4: // open prison and spawn prisoner
        ...
        me->SummonCreature(ENTRY_PRISONER, prison->m_positionX, prison->m_positionY, prison->m_positionZ, 0,
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_commander_ameerAI(pCreature); }
...
public:
  ...
  struct npc_reflection_of_ya_sixAI : public ScriptedAI {
    npc_reflection_of_ya_sixAI(Creature *pCreature)
        : ScriptedAI(pCreature), doSpawnText(true), doSenseArconusText(true), doExitCaveText(true) {}
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_reflection_of_ya_sixAI(pCreature); }
};
...
public:
  ...
  bool OnGossipHello(Player *player, GameObject *_GO) override {
    ...
    case 3726: // b'naar
      if ((player->GetQuestStatus(10299) == QUEST_STATUS_INCOMPLETE ||
           player->GetQuestStatus(10329) == QUEST_STATUS_INCOMPLETE) &&
          player->HasItemCount(29366, 1))
        manaforge = player->SummonCreature(ENTRY_BNAAR_C_CONSOLE, 2918.95f, 4189.98f, 161.88f, 0.34f,
                                           TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 125000);
      break;
    case 3730: // coruu
      if ((player->GetQuestStatus(10321) == QUEST_STATUS_INCOMPLETE ||
           player->GetQuestStatus(10330) == QUEST_STATUS_INCOMPLETE) &&
          player->HasItemCount(29396, 1))
        manaforge = player->SummonCreature(ENTRY_CORUU_C_CONSOLE, 2426.77f, 2750.38f, 133.24f, 2.14f,
                                           TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 125000);
      break;
    case 3734: // duro
      if ((player->GetQuestStatus(10322) == QUEST_STATUS_INCOMPLETE ||
           player->GetQuestStatus(10338) == QUEST_STATUS_INCOMPLETE) &&
          player->HasItemCount(29397, 1))
        manaforge = player->SummonCreature(ENTRY_DURO_C_CONSOLE, 2976.48f, 2183.29f, 163.20f, 1.85f,
                                           TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 125000);
      break;
    case 3722: // ara
      if ((player->GetQuestStatus(10323) == QUEST_STATUS_INCOMPLETE ||
           player->GetQuestStatus(10365) == QUEST_STATUS_INCOMPLETE) &&
          player->HasItemCount(29411, 1))
        manaforge = player->SummonCreature(ENTRY_ARA_C_CONSOLE, 4013.71f, 4028.76f, 192.10f, 1.25f,
                                           TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 125000);
      break;
    }

    if (manaforge) {
      ((npc_manaforge_control_console::npc_manaforge_control_consoleAI *)manaforge->AI())->someplayer =
          player->GetGUID();
