...
enum KurutiSpells { SPELL_LIGHTNINGSHIELD = 12550, SPELL_HEALINGWAVE = 11986, SPELL_CHAINLIGHTNING = 12058 };
...
enum eTimothy { GOSSIP_TEXTID_TIMOTHY_DANIELS1 = 9239 };
...
static Pos M[] = {{1206.926f, 8139.298f, 19.70f},  {1206.927f, 8158.908f, 19.51f}, {1220.742f, 8093.757f, 18.120f},
                  {1128.926f, 8137.008f, 20.664f}, {1230.289f, 8156.368f, 18.40f}, {1216.511f, 8188.199f, 18.70f}};
...
enum DrudgeSlave { NPC_DARKSCRESTSLAVER = 19946, NPC_DREGHOODSLAVE = 18122 };
...
public:
  ...
  bool OnGossipSelect(Player *player, Creature *pCreature, uint32 /*sender*/, uint32 action) override {
    if (action == GOSSIP_ACTION_INFO_DEF + 1) {
      ...
      pCreature->SetMaxPower(POWER_MANA,
                             200); // set a "fake" mana value, we can't depend on database doing it in this case
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_cooshcooshAI(pCreature); }
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_kayra_longmaneAI(pCreature); }
...
public:
  ...
  bool OnGossipHello(Player *pPlayer, Creature *pCreature) override {
    ...
    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TIMOTHY_DANIELS_ITEM1, GOSSIP_SENDER_MAIN,
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_baby_murlocAI(creature); }
};
...
public:
  ...
  struct npc_scoutjyobaAI : public ScriptedAI {
    ...
    void Reset() { me->SetStandState(UNIT_STAND_STATE_DEAD); }

    void UpdateAI(const uint32 diff) {}
  };

  CreatureAI *GetAI(Creature *creature) const { return new npc_scoutjyobaAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_wrektslaveAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_dreghooddrudgeAI(creature); }
};
