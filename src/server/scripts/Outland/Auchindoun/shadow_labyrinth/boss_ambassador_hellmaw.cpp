...
public:
  ...
  struct boss_ambassador_hellmawAI : public ScriptedAI {
    ...
    void KilledUnit(Unit *) { DoScriptText(RAND(SAY_SLAY1, SAY_SLAY2), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_ambassador_hellmawAI>(pCreature); }
};
