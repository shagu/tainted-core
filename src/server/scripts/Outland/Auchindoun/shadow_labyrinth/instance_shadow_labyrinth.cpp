...
public:
  ...
  struct instance_shadow_labyrinthAI : public ScriptedInstance {
    instance_shadow_labyrinthAI(Map *map) : ScriptedInstance(map) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_shadow_labyrinthAI(pMap); }
};
void AddSC_instance_shadow_labyrinth() { new instance_shadow_labyrinth(); }
