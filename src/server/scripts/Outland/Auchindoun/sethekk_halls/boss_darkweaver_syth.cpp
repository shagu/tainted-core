...
public:
  ...
  struct boss_darkweaver_sythAI : public ScriptedAI {
    ...
    void KilledUnit(Unit *) { DoScriptText(RAND(SAY_SLAY_1, SAY_SLAY_2), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_darkweaver_sythAI>(pCreature); }
};
...
public:
  ...
  struct mob_syth_fireAI : public ScriptedAI {
    ...
    void Reset() { me->ApplySpellImmune(0, IMMUNITY_SCHOOL, SPELL_SCHOOL_MASK_FIRE, true); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_syth_fireAI(pCreature); }
};
...
public:
  ...
  struct mob_syth_arcaneAI : public ScriptedAI {
    ...
    void Reset() { me->ApplySpellImmune(0, IMMUNITY_SCHOOL, SPELL_SCHOOL_MASK_ARCANE, true); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_syth_arcaneAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_syth_frostAI(pCreature); }
};
...
public:
  ...
  struct mob_syth_shadowAI : public ScriptedAI {
    ...
    void Reset() { me->ApplySpellImmune(0, IMMUNITY_SCHOOL, SPELL_SCHOOL_MASK_SHADOW, true); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_syth_shadowAI(pCreature); }
};
