...
public:
  ...
  struct instance_the_eyeAI : public ScriptedInstance {
    instance_the_eyeAI(Map *map) : ScriptedInstance(map) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_the_eyeAI(pMap); }
};
