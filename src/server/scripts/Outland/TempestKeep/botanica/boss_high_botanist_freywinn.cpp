...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_high_botanist_freywinnAI(pCreature); }
};

void AddSC_boss_high_botanist_freywinn() { new boss_high_botanist_freywinn(); }
