...
SDName: Arcatraz
SD%Complete: 60
SDComment: Warden Mellichar, event controller for Skyriss event. Millhouse Manastorm. @todo make better combatAI for
Millhouse. SDCategory: Tempest Keep, The Arcatraz EndScriptData */
...
public:
  ...
  struct npc_millhouse_manastormAI : public ScriptedAI {
    npc_millhouse_manastormAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_millhouse_manastormAI(pCreature); }
};
...
public:
  ...
  struct npc_warden_mellicharAI : public ScriptedAI {
    npc_warden_mellicharAI(Creature *c) : ScriptedAI(c) { pInstance = (ScriptedInstance *)c->GetInstanceData(); }
      ...
      if (EventProgress_Timer <= diff) {
        ...
        if (CanSpawn) {
          ...
          case 2:
            switch (rand() % 2) {
            case 0:
              me->SummonCreature(ENTRY_TRICKSTER, 478.326f, -148.505f, 42.56f, 3.19f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            case 1:
              me->SummonCreature(ENTRY_PH_HUNTER, 478.326f, -148.505f, 42.56f, 3.19f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            }
            break;
          case 3:
            me->SummonCreature(ENTRY_MILLHOUSE, 413.292f, -148.378f, 42.56f, 6.27f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                               600000);
            break;
          case 4:
          ...
          case 5:
            switch (rand() % 2) {
            case 0:
              me->SummonCreature(ENTRY_AKKIRIS, 420.179f, -174.396f, 42.58f, 0.02f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            case 1:
              me->SummonCreature(ENTRY_SULFURON, 420.179f, -174.396f, 42.58f, 0.02f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            }
            break;
          case 6:
            switch (rand() % 2) {
            case 0:
              me->SummonCreature(ENTRY_TW_DRAK, 471.795f, -174.58f, 42.58f, 3.06f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            case 1:
              me->SummonCreature(ENTRY_BL_DRAK, 471.795f, -174.58f, 42.58f, 3.06f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                 600000);
              break;
            }
            break;
          case 7:
            me->SummonCreature(ENTRY_SKYRISS, 445.763f, -191.639f, 44.64f, 1.60f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                               600000);
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_warden_mellicharAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_zerekethvoidzoneAI(pCreature); }
};
