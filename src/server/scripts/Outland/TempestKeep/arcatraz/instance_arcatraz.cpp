...
public:
  ...
  struct instance_arcatrazAI : public ScriptedInstance {
    instance_arcatrazAI(Map *map) : ScriptedInstance(map) { Initialize(); };
  ...
  InstanceData *GetInstanceScript(InstanceMap *map) const override { return new instance_arcatrazAI(map); }
};
