...
public:
  ...
  struct boss_mechano_lord_capacitusAI : public ScriptedAI {
    ...
    void JustDied(Unit * /*victim*/) { DoScriptText(YELL_DEATH, me, nullptr); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_mechano_lord_capacitusAI(pCreature); }
};

void AddSC_boss_mechano_lord_capacitus() { new boss_mechano_lord_capacitus(); }
