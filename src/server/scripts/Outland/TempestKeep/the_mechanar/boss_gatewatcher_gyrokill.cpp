...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_gatewatcher_gryoAI>(pCreature); }
};

void AddSC_boss_gatewatcher_gryo() { new boss_gatewatcher_gryo(); }
