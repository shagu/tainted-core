...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_pathaleon_the_calculatorAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_nether_wraithAI(pCreature); }
};
