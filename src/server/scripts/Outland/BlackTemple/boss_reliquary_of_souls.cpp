...
static Position2d Coords[] = {{450.4f, 212.3f}, {542.1f, 212.3f}, {542.1f, 168.3f},
                              {542.1f, 137.4f}, {450.4f, 137.4f}, {450.4f, 168.3f}};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new npc_enslaved_soulAI(pCreature); }
};
...
public:
  ...
  struct boss_reliquary_of_soulsAI : public ScriptedAI {
    ...
    bool SummonSoul() {
      ...
      Creature *Soul = me->SummonCreature(CREATURE_ENSLAVED_SOUL, x, y, me->GetPositionZ(), me->GetOrientation(),
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_reliquary_of_soulsAI>(pCreature); }
};
...
public:
  ...
  struct boss_essence_of_sufferingAI : public ScriptedAI {
    ...
    void KilledUnit(Unit * /*victim*/) { DoScriptText(RAND(SUFF_SAY_SLAY1, SUFF_SAY_SLAY2, SUFF_SAY_SLAY3), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_essence_of_sufferingAI(pCreature); }
};
...
public:
  ...
  struct boss_essence_of_desireAI : public ScriptedAI {
    ...
    void KilledUnit(Unit * /*victim*/) { DoScriptText(RAND(DESI_SAY_SLAY1, DESI_SAY_SLAY2, DESI_SAY_SLAY3), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_essence_of_desireAI(pCreature); }
};
...
public:
  ...
  struct boss_essence_of_angerAI : public ScriptedAI {
    ...
    void JustDied(Unit * /*victim*/) { DoScriptText(ANGER_SAY_DEATH, me); }

    void KilledUnit(Unit * /*victim*/) { DoScriptText(RAND(ANGER_SAY_SLAY1, ANGER_SAY_SLAY2), me); }
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new boss_essence_of_angerAI(pCreature); }
};
