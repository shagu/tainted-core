...
public:
  ...
  struct instance_rampartsAI : public ScriptedInstance {
    instance_rampartsAI(Map *map) : ScriptedInstance(map) { Initialize(); }
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_rampartsAI(pMap); }
};
void AddSC_instance_ramparts() { new instance_ramparts(); }
