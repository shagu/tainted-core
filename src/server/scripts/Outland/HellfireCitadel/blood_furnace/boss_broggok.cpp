...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_broggokAI>(pCreature); }
};
...
enum OrcSpells { SPELL_BLOW = 22427, SPELL_STOMP = 31900 };
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<mob_nascent_orcAI>(pCreature); }
};
...
public:
  ...
  struct mob_broggok_poisoncloudAI : public ScriptedAI {
    ...
    void Reset() { DoCast(me, HeroicMode ? SPELL_POISON_CLOUD_PASSIVE_H : SPELL_POISON_CLOUD_PASSIVE); }

    void AttackedBy(Unit * /*who*/) {}
    void AttackStart(Unit * /*who*/) {}
  };

  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<mob_broggok_poisoncloudAI>(pCreature); }
};
