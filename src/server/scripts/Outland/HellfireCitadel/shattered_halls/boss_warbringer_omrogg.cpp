...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new mob_omrogg_headsAI(pCreature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return GetInstanceAI<boss_warbringer_omroggAI>(pCreature); }
};
