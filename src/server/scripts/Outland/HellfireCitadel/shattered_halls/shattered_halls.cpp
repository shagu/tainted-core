...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_honorfallendefenderAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_honorfalleninfantryAI(creature); }
};
...
public:
  ...
  struct npc_shattered_legionnaireAI : public ScriptedAI {
    ...
    void SummonReplacement() {
      me->SummonCreature(16699, me->GetPositionX() - 10.0f, me->GetPositionY() - 10.0f, me->GetPositionZ(), 0,
                         TEMPSUMMON_CORPSE_TIMED_DESPAWN, 120000);
    }

    void SummonReplacement1() {
      me->SummonCreature(17420, me->GetPositionX() - 10.0f, me->GetPositionY() - 10.0f, me->GetPositionZ(), 0,
                         TEMPSUMMON_CORPSE_TIMED_DESPAWN, 120000);
    }

    void SummonReplacement2() {
      me->SummonCreature(17694, me->GetPositionX() - 10.0f, me->GetPositionY() - 10.0f, me->GetPositionZ(), 0,
                         TEMPSUMMON_CORPSE_TIMED_DESPAWN, 120000);
    }

    void SummonReplacement3() {
      me->SummonCreature(16594, me->GetPositionX() - 10.0f, me->GetPositionY() - 10.0f, me->GetPositionZ(), 0,
                         TEMPSUMMON_CORPSE_TIMED_DESPAWN, 120000);
    }
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_shattered_legionnaireAI(creature); }
};
...
public:
  ...
  CreatureAI *GetAI(Creature *creature) const { return new npc_shatteredscoutAI(creature); }
};
