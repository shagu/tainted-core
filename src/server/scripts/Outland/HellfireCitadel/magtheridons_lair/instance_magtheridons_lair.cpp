...
public:
  ...
  struct instance_magtheridons_lairAI : public ScriptedInstance {
    instance_magtheridons_lairAI(Map *Map) : ScriptedInstance(Map) { Initialize(); }
  ...
  InstanceData *GetInstanceScript(InstanceMap *pMap) const override { return new instance_magtheridons_lairAI(pMap); }
};
