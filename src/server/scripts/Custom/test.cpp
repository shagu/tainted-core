  ...
  public:
    ...
    void WaypointReached(uint32 i) {
      ...
      case 3: {
        ...
        Creature *temp = me->SummonCreature(21878, me->GetPositionX() + 5, me->GetPositionY() + 7, me->GetPositionZ(),
                                            0, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 3000);
        if (temp)
    ...
    void Aggro(Unit *) {
      if (HasEscortState(STATE_ESCORT_ESCORTING))
        ...
        me->Say(SAY_AGGRO2, LANG_UNIVERSAL, 0);
    }
    ...
    void JustDied(Unit *killer) {
      if (HasEscortState(STATE_ESCORT_ESCORTING)) {
        ...
        if (killer == me) {
          ...
          me->Say(SAY_DIE1, LANG_UNIVERSAL, GetPlayerForEscort()->GetGUID());
      } else
        me->Say(SAY_DIE2, LANG_UNIVERSAL, 0);
    }
