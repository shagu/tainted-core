...
public:
      ...
      if (!me->GetVictim()) {
        ...
        if (Say_Timer <= diff) {
          ...
          case 0:
            ...
            DoPlaySoundToSet(
                me, 8831); // 8831 is the index of the sound we are playing. You find these numbers in SoundEntries.dbc
            break;
  ...
  CreatureAI *GetAI(Creature *pCreature) const { return new custom_exampleAI(pCreature); }
};
...
void AddSC_custom_example() { new custom_example; }
